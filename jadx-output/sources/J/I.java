...
public abstract class I {
    ...
    public static q0 b(View view, q0 q0Var, Rect rect) {
        ...
        if (windowInsetsE != null) {
            return q0.f(view.computeSystemWindowInsets(windowInsetsE, rect), view);
        }
        rect.setEmpty();
        return q0Var;
    }
    ...
    public static q0 j(View view) throws IllegalAccessException, IllegalArgumentException {
        if (!f0.f976d || !view.isAttachedToWindow()) {
            return null;
        }
        try {
            Object obj = f0.f973a.get(view.getRootView());
            if (obj == null) {
                return null;
            }
            Rect rect = (Rect) f0.f974b.get(obj);
            Rect rect2 = (Rect) f0.f975c.get(obj);
            if (rect == null || rect2 == null) {
                return null;
            }
            h0 h0Var = new h0();
            h0Var.g(B.c.b(rect.left, rect.top, rect.right, rect.bottom));
            h0Var.e(B.c.b(rect2.left, rect2.top, rect2.right, rect2.bottom));
            q0 q0VarB = h0Var.b();
            q0VarB.f1002a.m(q0VarB);
            q0VarB.f1002a.d(view.getRootView());
            return q0VarB;
    ...
    public static void u(View view, InterfaceC0043q interfaceC0043q) {
        if (interfaceC0043q == null) {
            view.setOnApplyWindowInsetsListener((View.OnApplyWindowInsetsListener) view.getTag(R.id.tag_window_insets_animation_callback));
        } else {
            view.setOnApplyWindowInsetsListener(new H(view, interfaceC0043q));
        }
    }
