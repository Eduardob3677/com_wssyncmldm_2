...
public final class C0564J implements ListAdapter, SpinnerAdapter {

    /* renamed from: c, reason: collision with root package name */
    public SpinnerAdapter f7707c;

    /* renamed from: d, reason: collision with root package name */
    public ListAdapter f7708d;

    @Override // android.widget.ListAdapter
    public final boolean areAllItemsEnabled() {
        ListAdapter listAdapter = this.f7708d;
        if (listAdapter != null) {
    ...
    public final int getCount() {
        SpinnerAdapter spinnerAdapter = this.f7707c;
