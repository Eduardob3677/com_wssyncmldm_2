...
public abstract class w {
    ...
    public static void c(F.i iVar) {
        LocaleList.setDefault(LocaleList.forLanguageTags(iVar.f659a.f660a.toLanguageTags()));
    }

    public static void d(Configuration configuration, F.i iVar) {
        configuration.setLocales(LocaleList.forLanguageTags(iVar.f659a.f660a.toLanguageTags()));
    }
}
