...
public final class d {
    ...
    public final R0.c f2175b;

    /* renamed from: c, reason: collision with root package name */
    public final b f2176c;

    public d(Context context, R0.c cVar, b bVar) {
        this.f2174a = context;
        this.f2175b = cVar;
        this.f2176c = bVar;
    }

    public final void a(L0.b bVar, int i5, boolean z4) {
        Context context = this.f2174a;
        ComponentName componentName = new ComponentName(context, (Class<?>) JobInfoSchedulerService.class);
        JobScheduler jobScheduler = (JobScheduler) context.getSystemService("jobscheduler");
        Adler32 adler32 = new Adler32();
        adler32.update(context.getPackageName().getBytes(Charset.forName("UTF-8")));
        adler32.update(bVar.f1314a.getBytes(Charset.forName("UTF-8")));
        ByteBuffer byteBufferAllocate = ByteBuffer.allocate(4);
        I0.c cVar = bVar.f1316c;
        adler32.update(byteBufferAllocate.putInt(U0.a.a(cVar)).array());
        ...
        if (!z4) {
            ...
            while (true) {
                ...
                if (next.getId() == value) {
                    if (i6 >= i5) {
                        W1.a.t("JobInfoScheduler", "Upload for context %s is already scheduled. Returning...", bVar);
                        return;
                    }
                }
            }
        }
        SQLiteDatabase sQLiteDatabaseG = ((R0.h) this.f2175b).g();
        String strValueOf = String.valueOf(U0.a.a(cVar));
        ...
        try {
            ...
            Set set = ((c) bVar2.f2170b.get(cVar)).f2173c;
            if (set.contains(e.f2177c)) {
                builder.setRequiredNetworkType(2);
            } else {
                builder.setRequiredNetworkType(1);
            }
            if (set.contains(e.f2179e)) {
                builder.setRequiresCharging(true);
            }
            if (set.contains(e.f2178d)) {
                builder.setRequiresDeviceIdle(true);
            }
            PersistableBundle persistableBundle = new PersistableBundle();
            persistableBundle.putInt("attemptNumber", i5);
            persistableBundle.putString("backendName", str);
            persistableBundle.putInt("priority", U0.a.a(cVar));
            if (bArr != null) {
