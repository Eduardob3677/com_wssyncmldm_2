...
public abstract class d {
    ...
    public static final c f780a = new c(0);

    public static B1.e a(Context context, D3.e eVar) throws Resources.NotFoundException, PackageManager.NameNotFoundException {
        Cursor cursorQuery;
        PackageManager packageManager = context.getPackageManager();
        Resources resources = context.getResources();
        String str = (String) eVar.f499d;
        ProviderInfo providerInfoResolveContentProvider = packageManager.resolveContentProvider(str, 0);
        if (providerInfoResolveContentProvider == null) {
            throw new PackageManager.NameNotFoundException(AbstractC0432c.i("No package found for authority: ", str));
        }
        String str2 = providerInfoResolveContentProvider.packageName;
        String str3 = (String) eVar.f500e;
        if (!str2.equals(str3)) {
        ...
        try {
            ...
            return new B1.e(0, (i[]) arrayList3.toArray(new i[0]));
        } catch (Throwable th) {
            if (cursorQuery != null) {
                cursorQuery.close();
            }
