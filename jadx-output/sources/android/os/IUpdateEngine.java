...
public interface IUpdateEngine extends IInterface {
    ...
    public static class Default implements IUpdateEngine {
        ...
        @Override // android.os.IUpdateEngine
        public void applyPayload(String str, long j3, long j5, String[] strArr) {
        }

        @Override // android.os.IUpdateEngine
        public void applyPayloadFd(ParcelFileDescriptor parcelFileDescriptor, long j3, long j5, String[] strArr) {
        }
    ...
    public static class _Parcel {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static <T extends Parcelable> void writeTypedObject(Parcel parcel, T t2, int i5) {
            if (t2 == null) {
                parcel.writeInt(0);
            } else {
                parcel.writeInt(1);
                t2.writeToParcel(parcel, i5);
            }
        }
    }
    ...
    void applyPayload(String str, long j3, long j5, String[] strArr);

    void applyPayloadFd(ParcelFileDescriptor parcelFileDescriptor, long j3, long j5, String[] strArr);
