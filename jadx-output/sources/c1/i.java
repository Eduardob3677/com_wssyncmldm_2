...
public abstract class i {
    ...
    public static final C0722k f5212a = new C0722k();

    public static String a(Context context) {
        String packageName = context.getPackageName();
        try {
            Context context2 = C0554a.a(context).f1317a;
    ...
    public static String d(Context context, String str) {
        ...
        C0722k c0722k = f5212a;
        synchronized (c0722k) {
            try {
                String str2 = (String) c0722k.getOrDefault(str, null);
                if (str2 != null) {
                    return str2;
                }
                int i5 = Z0.g.f3009c;
