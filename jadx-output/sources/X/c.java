...
public final class c extends androidx.emoji2.text.h {
    ...
    public final WeakReference f2848b;

    public c(TextView textView, d dVar) {
        this.f2847a = new WeakReference(textView);
        this.f2848b = new WeakReference(dVar);
    }
    ...
    public final void b() {
        InputFilter[] filters;
        int length;
        TextView textView = (TextView) this.f2847a.get();
        InputFilter inputFilter = (InputFilter) this.f2848b.get();
        ...
        for (InputFilter inputFilter2 : filters) {
            if (inputFilter2 == inputFilter) {
                if (textView.isAttachedToWindow()) {
                    ...
                    CharSequence charSequenceF = jVarA.f(text, 0, length);
