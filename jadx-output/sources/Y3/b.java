...
public final class b {
    ...
    public static b b(Q3.b bVar) {
        Q3.c cVarH = bVar.h();
        String strReplace = bVar.i().b().replace('.', '$');
        if (cVarH.d()) {
            return new b(strReplace);
        }
        return new b(cVarH.b().replace('.', IDMTndsXmlWbxmlDefine.XML_SLASH) + "/" + strReplace);
    }

    public static b c(Q3.c cVar) {
        if (cVar != null) {
    ...
    public final boolean equals(Object obj) {
        ...
        return this.f2964a.equals(((b) obj).f2964a);
    }
