...
public abstract class j {
    ...
    public static final HashMap f3056a;
        ...
        try {
            ...
            if (!TextUtils.isEmpty(string) && !TextUtils.isEmpty(string2)) {
                ...
                if (map.containsKey(string)) {
                    ...
                    sb.append(":");
                    sb.append(string2);
                    return AbstractC0420a.t0(sb.toString());
                }
            }
            String strValueOf = String.valueOf(str);
            return AbstractC0420a.t0(strValueOf.length() != 0 ? "WEB_INTERNAL_ERROR:".concat(strValueOf) : new String("WEB_INTERNAL_ERROR:"));
            ...
            sb2.append(" ]");
            return AbstractC0420a.t0(sb2.toString());
        }
    }
}
