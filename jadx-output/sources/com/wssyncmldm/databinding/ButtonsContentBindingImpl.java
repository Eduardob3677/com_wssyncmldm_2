...
public class ButtonsContentBindingImpl extends ButtonsContentBinding {
    private static final q sIncludes = null;
    private static final SparseIntArray sViewsWithIds = null;
    private long mDirtyFlags;

    public ButtonsContentBindingImpl(f fVar, View view) {
    ...
    private ButtonsContentBindingImpl(f fVar, View view, Object[] objArr) {
        super(fVar, view, 0, (ButtonWithLimitedFontSizeAndWidth) objArr[2], (ButtonWithLimitedFontSizeAndWidth) objArr[1], (LinearLayout) objArr[0], null);
        this.mDirtyFlags = -1L;
