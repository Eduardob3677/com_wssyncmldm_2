...
public final class OnItemSelected implements a {
    ...
    public interface Listener {
        void _internalCallbackOnItemSelected(int i5, AdapterView adapterView, View view, int i6, long j3);
    }
    ...
    public void onItemSelected(AdapterView adapterView, View view, int i5, long j3) {
        this.mListener._internalCallbackOnItemSelected(this.mSourceId, adapterView, view, i5, j3);
    }
}
