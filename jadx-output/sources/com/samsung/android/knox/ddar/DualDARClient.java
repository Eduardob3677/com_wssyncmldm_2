...
public abstract class DualDARClient extends Service {
    ...
    public abstract void onClearResetPasswordToken(int i5, long j3);
    ...
    public abstract boolean onResetPasswordWithToken(int i5, byte[] bArr, long j3, byte[] bArr2);

    public abstract boolean onSetResetPasswordToken(int i5, byte[] bArr, long j3, byte[] bArr2);
