...
public class BasePasswordPolicy {
    ...
    public boolean resetPassword(String str, int i5) {
        throw new RuntimeException("Stub!");
    }

    public boolean resetPasswordWithToken(ComponentName componentName, String str, byte[] bArr, int i5) {
        throw new RuntimeException("Stub!");
    }

    public void setKeyguardDisabledFeatures(ComponentName componentName, int i5) {
        throw new RuntimeException("Stub!");
    }

    public void setMaximumFailedPasswordsForWipe(ComponentName componentName, int i5) {
        throw new RuntimeException("Stub!");
    }

    public void setMaximumTimeToLock(ComponentName componentName, long j3) {
        throw new RuntimeException("Stub!");
    }

    public void setPasswordExpirationTimeout(ComponentName componentName, long j3) {
        throw new RuntimeException("Stub!");
    }

    public void setPasswordHistoryLength(ComponentName componentName, int i5) {
        throw new RuntimeException("Stub!");
    }

    public void setPasswordMinimumLength(ComponentName componentName, int i5) {
        throw new RuntimeException("Stub!");
    }

    public void setPasswordMinimumLetters(ComponentName componentName, int i5) {
        throw new RuntimeException("Stub!");
    }

    public void setPasswordMinimumLowerCase(ComponentName componentName, int i5) {
        throw new RuntimeException("Stub!");
    }

    public void setPasswordMinimumNonLetter(ComponentName componentName, int i5) {
        throw new RuntimeException("Stub!");
    }

    public void setPasswordMinimumNumeric(ComponentName componentName, int i5) {
        throw new RuntimeException("Stub!");
    }

    public void setPasswordMinimumSymbols(ComponentName componentName, int i5) {
        throw new RuntimeException("Stub!");
    }

    public void setPasswordMinimumUpperCase(ComponentName componentName, int i5) {
        throw new RuntimeException("Stub!");
    }

    public void setPasswordQuality(ComponentName componentName, int i5) {
        throw new RuntimeException("Stub!");
    }
