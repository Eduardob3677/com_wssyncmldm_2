...
public class EmailAccountPolicy {
    ...
    public boolean setInComingProtocol(String str, long j3) {
        throw new RuntimeException("Stub!");
    }

    public boolean setInComingServerAcceptAllCertificates(boolean z4, long j3) {
        throw new RuntimeException("Stub!");
    }

    public long setInComingServerAddress(String str, long j3) {
        throw new RuntimeException("Stub!");
    }

    public boolean setInComingServerPassword(String str, long j3) {
        throw new RuntimeException("Stub!");
    }

    public boolean setInComingServerPort(int i5, long j3) {
        throw new RuntimeException("Stub!");
    }

    public boolean setInComingServerSSL(boolean z4, long j3) {
        throw new RuntimeException("Stub!");
    }

    public boolean setOutGoingServerAcceptAllCertificates(boolean z4, long j3) {
        throw new RuntimeException("Stub!");
    }

    public long setOutGoingServerAddress(String str, long j3) {
        throw new RuntimeException("Stub!");
    }

    public boolean setOutGoingServerPassword(String str, long j3) {
        throw new RuntimeException("Stub!");
    }

    public boolean setOutGoingServerPort(int i5, long j3) {
        throw new RuntimeException("Stub!");
    }

    public boolean setOutGoingServerSSL(boolean z4, long j3) {
        throw new RuntimeException("Stub!");
    }

    public boolean setSenderName(String str, long j3) {
        throw new RuntimeException("Stub!");
    }
