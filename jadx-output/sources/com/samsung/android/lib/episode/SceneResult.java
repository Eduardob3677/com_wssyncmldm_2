    ...
    public static class Builder {
        ...
        private boolean isValid() {
            ...
            if (resultType == ResultType.RESULT_UNDEFINED) {
                ...
                throw new IllegalArgumentException(f.w(new StringBuilder("["), this.mKey, "] mResultType is undefined. Need setResultType(ResultType)"));
            }
            if (resultType != ResultType.RESULT_FAIL) {
                ...
                throw new IllegalArgumentException(f.w(new StringBuilder("["), this.mKey, "] If result type is RESULT_SKIP, ErrorType must be one of DEFAULT_VALUE or FAST_TRACK"));
            }
            ErrorType errorType2 = this.mErrorType;
            if (errorType2 == null) {
                Log.e(SceneResult.TAG, "[" + this.mKey + "] ErrorType is null");
                throw new IllegalArgumentException(f.w(new StringBuilder("["), this.mKey, "] ErrorType is null. Need setErrorType(ErrorType)"));
            }
            ...
            throw new IllegalArgumentException(f.w(new StringBuilder("["), this.mKey, "] mErrorReasonList is null. Need setErrorReason(List)"));
        }
