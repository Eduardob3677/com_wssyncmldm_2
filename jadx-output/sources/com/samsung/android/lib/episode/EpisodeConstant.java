...
public class EpisodeConstant {
    ...
    public static final String R_DTD_VERSION = "3.61";
    public static final int R_VERSION_CODE = 30;
    public static final String S_DTD_VERSION = "4.40";
    public static final int S_V2_VERSION_CODE = 32;
    public static final int S_VERSION_CODE = 31;
    public static final String T_DTD_VERSION = "5.68";
    public static final int T_VERSION_CODE = 33;
    public static final String U_DTD_VERSION = "6.89";
    public static final int U_VERSION_CODE = 34;
    public static final String V_DTD_VERSION = "7.62";
    public static final int V_VERSION_CODE = 35;
}
