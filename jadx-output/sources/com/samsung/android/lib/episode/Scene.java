...
public class Scene implements Parcelable {
    ...
    public long getAttributeLong(String str, long j3) {
        Bundle bundle = this.mSceneValue;
        if (bundle != null && bundle.containsKey(str)) {
            String string = this.mSceneValue.getString(str);
            try {
    ...
    public double getValueDouble(double d2) {
        Bundle bundle = this.mSceneValue;
        if (bundle != null && bundle.containsKey("value")) {
            String string = this.mSceneValue.getString("value");
            try {
    ...
    public long getValueLong(long j3) {
        Bundle bundle = this.mSceneValue;
        if (bundle != null && bundle.containsKey("value")) {
            String string = this.mSceneValue.getString("value");
            try {
    ...
    public Scene(Parcel parcel) {
        ...
        this.mDefaultType = b3;
        this.mIsDefault = Boolean.valueOf(b3 > 0);
    }
}
