...
public class SendLogTask implements b {
    ...
    public void run() {
        try {
            ((a) this.dmaInterface).q(this.configuration.isEnableUseInAppLogging() ? 1 : 0, this.configuration.getTrackingId(), this.log.getType().getAbbrev(), this.log.getTimestamp(), this.log.getData());
        } catch (Exception e5) {
