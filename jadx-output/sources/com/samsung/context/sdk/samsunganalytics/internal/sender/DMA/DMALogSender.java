...
public class DMALogSender extends BaseLogSender {
    ...
    public void sendAll() {
        if (PolicyUtils.getSenderType() == 2 && this.dmaStatus == 0) {
            ...
            while (!queue.isEmpty()) {
                ((d) this.executor).g(new SendLogTask(this.dmaBinder.getDmaInterface(), this.configuration, queue.poll()));
            }
        }
    }
    ...
    public int send(Map<String, String> map) {
        ...
        if (PolicyUtils.getSenderType() == 3) {
            ...
            ((d) this.executor).g(new SendLogTaskV2(this.context, 2, contentValues));
        } else {
    ...
    public void sendCommon() {
        ...
        if (PolicyUtils.getSenderType() == 3) {
            ...
            ((d) this.executor).g(new SendLogTaskV2(this.context, 1, contentValues));
        } else {
            try {
