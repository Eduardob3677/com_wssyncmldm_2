...
public class Tracker {
    ...
    public Tracker(final Application application, final Configuration configuration) {
        ...
        d.h().g(new b() { // from class: com.samsung.context.sdk.samsunganalytics.internal.Tracker.2
            @Override // K2.b
            public int onFinish() {
                return 0;
            }
    ...
    private boolean hasPermission(Context context) {
        String[] strArr;
        PackageInfo packageInfoX = L2.b.x(context);
        if (packageInfoX != null && (strArr = packageInfoX.requestedPermissions) != null) {
    ...
    private void requestDeleteLogData(final RegisterType registerType) {
        d.h().g(new b() { // from class: com.samsung.context.sdk.samsunganalytics.internal.Tracker.6
            @Override // K2.b
            public int onFinish() {
                return 0;
            }
    ...
    private void sendAppCommon() {
        if ((Utils.isProvidingDataSupported(this.mContext) || isUserAgreement()) && PolicyUtils.getSenderType() == 3) {
            ...
            String strW = L2.b.w(this.mContext);
            if (TextUtils.isEmpty(strW)) {
                strW = WifiAdminProfile.PHASE2_NONE;
            }
            ...
            Debug.LogD("AppVersion = " + strW + ", prefAppVersion = " + string + ", beforeSendCommonTime = " + lValueOf + ", success = " + z4);
            if (!strW.equals(string) || ((z4 && Utils.compareDays(7, lValueOf)) || (!z4 && Utils.compareHours(6, lValueOf)))) {
                Debug.LogD("send app common");
                preferences.edit().putString(Preferences.PREFS_KEY_APP_VERSION, strW).putLong(Preferences.PREFS_KEY_SEND_COMMON_TIME, System.currentTimeMillis()).apply();
    ...
    private void setPolicy() {
        ...
        if (PolicyUtils.isPolicyExpired(this.mContext)) {
            PolicyUtils.updatePolicy(this.application, this.configuration, d.h(), DeviceInfo.getDeviceInfo(this.mContext), new Callback<Void, Boolean>() { // from class: com.samsung.context.sdk.samsunganalytics.internal.Tracker.7
    ...
    public void enableAutoActivityTracking() {
        d.h().g(new b() { // from class: com.samsung.context.sdk.samsunganalytics.internal.Tracker.4
            @Override // K2.b
            public int onFinish() {
                return 0;
            }
    ...
    public void registerSettingPref(final Map<String, Set<String>> map) {
        ...
        d.h().g(new b() { // from class: com.samsung.context.sdk.samsunganalytics.internal.Tracker.5
            @Override // K2.b
            public int onFinish() {
                return 0;
            }
    ...
    public int sendLog(final Map<String, String> map) {
        ...
        d.h().g(new b() { // from class: com.samsung.context.sdk.samsunganalytics.internal.Tracker.3
            @Override // K2.b
            public int onFinish() {
                return 0;
            }
