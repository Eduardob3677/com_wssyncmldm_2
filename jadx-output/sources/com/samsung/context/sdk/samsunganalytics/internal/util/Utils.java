...
public class Utils {
    ...
    public static boolean compareDays(int i5, Long l5) {
        return System.currentTimeMillis() > (((long) i5) * 86400000) + l5.longValue();
    }

    public static boolean compareHours(int i5, Long l5) {
        return System.currentTimeMillis() > (((long) i5) * 3600000) + l5.longValue();
    }
    ...
    public static boolean isAppVersionChanged(Context context) {
        String strW = b.w(context);
        String string = Preferences.getPreferences(context).getString(Preferences.PREFS_KEY_APP_VERSION_FOR_INIT, "");
        if (TextUtils.isEmpty(string)) {
            Preferences.getPreferences(context).edit().putString(Preferences.PREFS_KEY_APP_VERSION_FOR_INIT, strW).apply();
            return false;
        }
        if (string.equals(strW) || TextUtils.isEmpty(strW)) {
            return false;
        }
        Preferences.getPreferences(context).edit().putString(Preferences.PREFS_KEY_APP_VERSION_FOR_INIT, strW).apply();
        return true;
    ...
    public static boolean isDeletionOfSensitiveDataSupported(Context context) {
        return DMA_VERSION_SUPPORTED_DELETE_SENSITIVE_DATA <= b.m(context);
    }
    ...
    public static boolean isProvidingDataSupported(Context context) {
        return DMA_VERSION_PROVIDING_DATA <= b.m(context);
    }

    public static boolean isSendingAppCommonSupported(Context context) {
        return DMA_VERSION_NOT_SUPPORTED_APP_COMMON > b.m(context);
    }
    ...
    public static void registerReceiver(Context context, final Configuration configuration) {
        ...
        br = new BroadcastReceiver() { // from class: com.samsung.context.sdk.samsunganalytics.internal.util.Utils.1
            ...
            public void onReceive(final Context context2, Intent intent) {
                ...
                d.h().g(new K2.b() { // from class: com.samsung.context.sdk.samsunganalytics.internal.util.Utils.1.1
                    @Override // K2.b
                    public int onFinish() {
                        return 0;
                    }
