...
public class IDMMoDatabaseHelper extends SQLiteOpenHelper implements IDMMoInterface, IDMMoDatabaseConstants, Constants {
    ...
    private String idmMoDatabaseCreateTableToString(String str) {
        return f.v("CREATE TABLE IF NOT EXISTS '", str, "' (path TEXT NOT NULL PRIMARY KEY, name TEXT NOT NULL, acl TEXT, scope INTEGER  NOT NULL, format TEXT, type TEXT, depth INTEGER NOT NULL, value TEXT, largeobjsize INTEGER NOT NULL DEFAULT 0);");
    }
    ...
    private void idmMoMakeNode(SQLiteDatabase sQLiteDatabase, String str, String str2, String str3, int i5, String str4, String str5, String str6) {
        ...
        try {
            Cursor cursorRawQuery = sQLiteDatabase.rawQuery("SELECT name FROM '" + str + "' WHERE " + f.v("path = '", str2, "'"), null);
            try {
