...
public abstract class IDMNetworkInfoAdapter implements IDMNetworkInterface, IDMDmInterface {
    ...
    private C0713b httpHeadersMap = new C0713b();
    ...
    public C0713b idmGetHttpHeadersMap() {
    ...
    public void idmMakeHttpHeader(int i5, HttpURLConnection httpURLConnection, String str, int i6) {
        ...
        if (!idmGetHttpHeadersMap().containsKey("Connection")) {
            if (i6 == 0) {
                httpURLConnection.setRequestProperty("Connection", IDMNetworkInterface.IDM_HTTP_CLOSE);
            } else {
                httpURLConnection.setRequestProperty("Connection", IDMNetworkInterface.IDM_HTTP_KEEPALIVE);
            }
        }
