...
public class InsecureSHA1PRNGKeyDerivator {
    ...
    private static final int f6316H0 = 1732584193;

    /* renamed from: H1, reason: collision with root package name */
    private static final int f6317H1 = -271733879;

    /* renamed from: H2, reason: collision with root package name */
    private static final int f6318H2 = -1732584194;

    /* renamed from: H3, reason: collision with root package name */
    private static final int f6319H3 = 271733878;
        ...
        try {
            ...
            while (true) {
                if (i10 == 0) {
                    ...
                    iArr5[i6] = ((int) ((j6 >>> RIGHT1[i10]) & MASK[i10])) | i11;
                    iArr5[i6 + 1] = (int) (j6 >>> RIGHT2[i10]);
                    iArr5[i6 + 2] = (int) ((j6 << LEFT[i10]) | END_FLAGS[i10]);
                }
                int[] iArr6 = this.seed;
                if (iArr6[81] > 48) {
