...
class IDMSecurityCrypt implements IDMSecurityInterface {
    ...
    private byte[] f6311C = new byte[28];

    /* renamed from: D, reason: collision with root package name */
    private byte[] f6312D = new byte[28];
    ...
    private byte[] idmCryptDESEncrypt(byte[] bArr) {
        ...
        for (int i6 = 0; i6 < 16; i6++) {
            ...
            for (int i9 = 0; i9 < 8; i9++) {
                ...
                int i10 = bArr6[b3] << 5;
                int i11 = bArr6[b3 + 1] << 3;
                int i12 = bArr6[b3 + 2] << 2;
                byte b5 = IDMSecurityInterface.f6314S[i9][i10 + i11 + i12 + (bArr6[b3 + 3] << 1) + bArr6[b3 + 4] + (bArr6[b3 + 5] << 4)];
                byte b6 = (byte) (i9 * 4);
            ...
            for (int i13 = 0; i13 < 32; i13++) {
                bArr3[i13] = (byte) (bArr2[i13] ^ bArr5[IDMSecurityInterface.f6313P[i13] - 1]);
            }
    ...
    private void idmCryptEExpandsion(byte[] bArr) {
        ...
        while (i5 < 2) {
            int i7 = i6 + 1;
            byte b3 = bArr[i6];
            this.m_cryptCryptByte[i5] = b3;
            byte b5 = (byte) (b3 > 90 ? b3 - 59 : b3 > 57 ? b3 - 53 : b3 - 46);
    ...
    private void idmCryptEncrypt(byte[] bArr) {
        ...
        while (i6 < 11) {
            ...
            for (int i7 = 0; i7 < 6; i7++) {
                b3 = (byte) (((byte) (b3 << 1)) | bArr[(i6 * 6) + i7]);
            }
            byte b5 = (byte) (b3 + 46);
            if (b5 > 57) {
                b5 = (byte) (b5 + 7);
    ...
    private void idmCryptSetKey(byte[] bArr) {
        for (int i5 = 0; i5 < 28; i5++) {
            this.f6311C[i5] = bArr[IDMSecurityInterface.PC1_C[i5] - 1];
            this.f6312D[i5] = bArr[IDMSecurityInterface.PC1_D[i5] - 1];
        }
        for (int i6 = 0; i6 < 16; i6++) {
            for (int i7 = 0; i7 < IDMSecurityInterface.shifts[i6]; i7++) {
                byte b3 = this.f6311C[0];
                int i8 = 0;
                while (i8 < 27) {
                    byte[] bArr2 = this.f6311C;
                    int i9 = i8 + 1;
                    bArr2[i8] = bArr2[i9];
                    i8 = i9;
                }
                this.f6311C[27] = b3;
                byte b5 = this.f6312D[0];
                int i10 = 0;
                while (i10 < 27) {
                    byte[] bArr3 = this.f6312D;
                    int i11 = i10 + 1;
                    bArr3[i10] = bArr3[i11];
                    i10 = i11;
                }
            ...
            for (int i12 = 0; i12 < 24; i12++) {
                ...
                bArr4[i12] = this.f6311C[IDMSecurityInterface.PC2_C[i12] - 1];
                bArr4[i12 + 24] = this.f6312D[IDMSecurityInterface.PC2_D[i12] - 29];
            }
        }
        for (int i13 = 0; i13 < 48; i13++) {
            this.E[i13] = IDMSecurityInterface.f6315e2[i13];
        }
    }
