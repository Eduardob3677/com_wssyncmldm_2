...
import com.idm.core.xml.IDMXmlSyncmlParser;
...
public class IDMDmAgent implements Constants, IDMDmInterface, IDMPushInterface, IDMCallbackStatusInterface, IDMNetworkInterface, IDMDlInterface {
    ...
    /* JADX WARN: Can't wrap try/catch for region: R(16:0|2|(2:141|(3:139|3|4))|(3:145|5|(2:7|(1:22)(1:11))(1:24))|(1:26)(12:28|(5:30|(1:32)|33|(1:35)|36)(2:38|(5:40|(1:42)|43|(1:45)|46)(1:47))|37|49|(1:51)|140|52|(1:54)(1:(3:58|(1:60)|61))|62|124|(1:126)|127)|27|49|(0)|140|52|(0)(0)|62|124|(0)|127|(1:(0))) */
    ...
    */
    private IDMNetworkSendRecvState idmRecvPackage(int i5, HttpURLConnection httpURLConnection, IDMSyncMLDataInfo iDMSyncMLDataInfo, IDMDmAbortInfo iDMDmAbortInfo) {
        IDMNetworkSendRecvHandler iDMNetworkSendRecvHandler;
        IDMNetworkHttpAdapter iDMNetworkHttpAdapter;
        IDMNetworkTimer iDMNetworkTimer;
        byte[] bArrIdmRecvHttpUrlConnection;
        String strIdmGetContentType;
        SyncML syncMLIdmSyncmlWbxmlDecoder;
        SyncML syncML;
        int i6;
        IDMNetworkTimer iDMNetworkTimer2;
        IDMDebug.I("idmRecvPackage for DM");
        IDMNetworkSendRecvHandler iDMNetworkSendRecvHandler2 = IDMNetworkSendRecvHandler.SUCCESS;
        ...
        try {
            try {
                try {
                    ...
                    iDMNetworkTimer = new IDMNetworkTimer(IDMNetworkInterface.IDMNetworkTimerMode.IDM_NETWORK_TIMER_MODE_RECEIVE, this.networkAdapter.idmGetConnectNetworkTimeOut(i5), this.networkAdapter.idmGetExtraTime(i5), iDMNetworkHttpAdapter, this.request);
                    this.networkTimer = iDMNetworkTimer;
                } catch (Throwable th) {
                    IDMNetworkTimer iDMNetworkTimer3 = this.networkTimer;
                    if (iDMNetworkTimer3 != null) {
                        iDMNetworkTimer3.idmNetworkEndTimer();
                        this.networkTimer = null;
                    }
                    try {
                        iDMSyncMLDataInfo.idmSetSyncMLData(null);
                        iDMDmAbortInfo.idmSetErrorCode(0);
                        iDMDmAbortInfo.idmSetResponseCode(iDMNetworkHttpHeaderInfo.idmGetResponseCode());
                        if (!IDMNetworkUserAction.getInstance().getUserCancel()) {
                            throw th;
                        }
                        IDMNetworkSendRecvHandler iDMNetworkSendRecvHandler3 = IDMNetworkSendRecvHandler.SUCCESS;
                        throw th;
                    } catch (Exception e5) {
                        IDMDebug.printStackTrace(e5);
                        throw th;
            ...
            } catch (IDMExceptionDmParsing e6) {
                e = e6;
            } catch (IDMExceptionHttpHeader e7) {
                e = e7;
            } catch (IDMExceptionHttpReceive e8) {
                e = e8;
            } catch (Exception e9) {
                e = e9;
            }
        ...
        try {
            bArrIdmRecvHttpUrlConnection = iDMNetworkHttpAdapter.idmRecvHttpUrlConnection(httpURLConnection, iDMNetworkHttpHeaderInfo, iDMNetworkTimer);
            if (bArrIdmRecvHttpUrlConnection != null) {
                strIdmGetContentType = iDMNetworkHttpHeaderInfo.idmGetContentType();
                idmCheckServerAuthHMAC(iDMNetworkHttpHeaderInfo.idmGetMacData(), bArrIdmRecvHttpUrlConnection);
                if (TextUtils.isEmpty(iDMNetworkHttpHeaderInfo.idmGetConnectionType()) || !iDMNetworkHttpHeaderInfo.idmGetConnectionType().equalsIgnoreCase(IDMNetworkInterface.IDM_HTTP_CLOSE)) {
                    ...
                    this.httpDmConnType = 0;
                }
            } else {
                strIdmGetContentType = "";
            }
        } catch (IDMExceptionDmParsing e11) {
            e = e11;
            IDMDebug.E("Syncml Parsing error");
            IDMDebug.I("HttpHeader Fail");
            ...
            if (IDMNetworkUserAction.getInstance().getUserCancel()) {
                ...
                if (this.request != null) {
                    iDMDmAbortInfo.setResponseHttpHeader(httpURLConnection.getHeaderFields());
            ...
            iDMNetworkSendRecvHandler2 = iDMNetworkSendRecvHandler;
            IDMDebug.I("============== idmRecvPackage =============");
            if (syncML2 != null) {
            }
            return iDMNetworkSendRecvHandler2;
        } catch (IDMExceptionHttpHeader e12) {
            e = e12;
            ...
            return iDMNetworkSendRecvHandler2;
        } catch (IDMExceptionHttpReceive e13) {
            e = e13;
            IDMDebug.I("HttpHeader Receive Fail");
            IDMDebug.printStackTrace(e);
            ...
            iDMSyncMLDataInfo.idmSetSyncMLData(null);
            iDMDmAbortInfo.idmSetErrorCode(503);
            iDMDmAbortInfo.idmSetResponseCode(iDMNetworkHttpHeaderInfo.idmGetResponseCode());
            if (IDMNetworkUserAction.getInstance().getUserCancel()) {
                iDMNetworkSendRecvHandler = IDMNetworkSendRecvHandler.USER_CANCEL;
            } else {
        ...
        if (strIdmGetContentType != null) {
            if (strIdmGetContentType.contains(Constants.MIMETYPE_SYNCML_DM_XML)) {
                if (IDMDebug.idmGetLogFileSaveState()) {
                    idmWriteDMSessionLog(bArrIdmRecvHttpUrlConnection, IDMDmInterface.IDM_FILE_EXTENSION_XML);
                }
                if (IDMDebug.idmGetDumpLogState()) {
                    IDMDebug.DUMP(bArrIdmRecvHttpUrlConnection, 0);
                }
                syncMLIdmSyncmlWbxmlDecoder = new IDMXmlSyncmlParser().idmSyncmlXmlDecoder(new ByteArrayInputStream(bArrIdmRecvHttpUrlConnection));
            } else if (strIdmGetContentType.contains("application/vnd.syncml.dm+wbxml")) {
                if (IDMDebug.idmGetLogFileSaveState()) {
                    idmWriteDMSessionLog(bArrIdmRecvHttpUrlConnection, IDMDmInterface.IDM_FILE_EXTENSION_WBXML);
                }
                if (IDMDebug.idmGetDumpLogState()) {
                    IDMDebug.DUMP(bArrIdmRecvHttpUrlConnection, 0);
                }
                syncMLIdmSyncmlWbxmlDecoder = new IDMWbxmlSyncmlParser().idmSyncmlWbxmlDecoder(bArrIdmRecvHttpUrlConnection);
            } else {
                IDMDebug.E(strIdmGetContentType.concat(" : not support Content-Type !!!"));
            }
            syncML = syncMLIdmSyncmlWbxmlDecoder;
            i6 = 0;
            ...
            iDMSyncMLDataInfo.idmSetSyncMLData(syncML);
            iDMDmAbortInfo.idmSetErrorCode(i6);
            iDMDmAbortInfo.idmSetResponseCode(iDMNetworkHttpHeaderInfo.idmGetResponseCode());
            if (!IDMNetworkUserAction.getInstance().getUserCancel()) {
                iDMNetworkSendRecvHandler2 = IDMNetworkSendRecvHandler.USER_CANCEL;
            } else if (i6 > 0) {
                if (this.request != null) {
                    iDMDmAbortInfo.setResponseHttpHeader(httpURLConnection.getHeaderFields());
                    new IDMNetworkHttpAdapter().idmDisconnectHttpUrlConnection(this.request);
                ...
                iDMNetworkSendRecvHandler2 = IDMNetworkSendRecvHandler.RETRY;
            }
            syncML2 = syncML;
            IDMDebug.I("============== idmRecvPackage =============");
            if (syncML2 != null) {
                IDMDebug.H(syncML2.toString());
            }
            return iDMNetworkSendRecvHandler2;
        }
        IDMDebug.E("contentType is null...");
        syncML = null;
        i6 = 505;
        iDMNetworkTimer2 = this.networkTimer;
        if (iDMNetworkTimer2 != null) {
