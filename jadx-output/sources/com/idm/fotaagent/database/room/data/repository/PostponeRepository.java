...
public class PostponeRepository extends PropertyRepository.SpecificCategory {
    ...
    public static class DataBuilder {
        ...
        public DataBuilder alarmTime(long j3) {
            this.data.put(PostponeRepository.NAME_ALARM_TIME, Long.valueOf(j3));
            return this;
        }
        ...
        public DataBuilder scheduledInstallTime(long j3) {
            this.data.put(PostponeRepository.NAME_SCHEDULED_INSTALL_TIME, Long.valueOf(j3));
            return this;
        }
    ...
    public /* synthetic */ void lambda$save$0(HashMap map) {
        map.forEach(new BiConsumer() { // from class: com.idm.fotaagent.database.room.data.repository.i
            ...
            public final void accept(Object obj, Object obj2) {
                this.f6366a.insertOrReplaceWithoutException((String) obj, (Serializable) obj2);
            }
        });
    }
    ...
    public void setScheduledInstallTime(long j3) {
        insertOrReplaceWithoutException(NAME_SCHEDULED_INSTALL_TIME, Long.valueOf(j3));
    }
}
