...
public abstract class FotaRoomDatabase extends androidx.room.j {
    private static String DATABASE_NAME = "fota_room";
    private static volatile FotaRoomDatabase INSTANCE;
    static final AbstractC0892a MIGRATION_6_7 = new PreferenceSettingPopulation.ByMigration();
    static final AbstractC0892a MIGRATION_7_8 = new PolicySettingPopulation.ByMigration();
    static final AbstractC0892a MIGRATION_8_9 = new BaseInfoPopulation.ByMigration();
    static final AbstractC0892a MIGRATION_9_10 = new DeviceRegistrationPopulation.ByMigration();

    public static class BaseInfoPopulation {

        public static class ByMigration extends AbstractC0892a {
            public ByMigration() {
                super(8, 9);
            }

            @Override // v0.AbstractC0892a
    ...
    public static class PolicySettingPopulation {
        ...
        public static void populate(SupportSQLiteDatabase supportSQLiteDatabase) {
            try {
                ...
                long j3 = Settings.System.getLong(contextIdmGetContext.getContentResolver(), POLICY_VALID_TIME, -1L);
                if (j3 != -1) {
                    CategoryNameValueDao.insertOrReplace(supportSQLiteDatabase, new Property(PolicyRepository.CATEGORY, PolicyRepository.NAME_EXPIRED_TIME, Long.valueOf(j3)));
                }
