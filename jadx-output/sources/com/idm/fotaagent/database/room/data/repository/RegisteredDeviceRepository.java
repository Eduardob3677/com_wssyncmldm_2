...
public class RegisteredDeviceRepository extends PropertyRepository.SpecificCategory {
    ...
    private static final String NAME_CORP_ID = "corpId";
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$save$0(String str, String str2, String str3, String str4) {
        ...
        insertOrReplaceWithoutException("corpId", str4);
    }
    ...
    public void save(final String str, final String str2, final String str3, final String str4) {
        runInTransaction(new Runnable() { // from class: com.idm.fotaagent.database.room.data.repository.j
            ...
            public final void run() {
                this.f6367c.lambda$save$0(str, str2, str3, str4);
            }
        });
    }
}
