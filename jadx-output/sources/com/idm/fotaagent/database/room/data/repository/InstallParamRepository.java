...
public class InstallParamRepository extends PropertyRepository.SpecificCategory {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$saveInstallParamForABUpdate$1(String str, long j3, String str2, long j5, long j6, long j7) {
        insertOrReplaceWithoutException(NAME_FILE_HASH, str);
        insertOrReplaceWithoutException(NAME_FILE_SIZE, Long.valueOf(j3));
        insertOrReplaceWithoutException(NAME_METADATA_HASH, str2);
        insertOrReplaceWithoutException(NAME_METADATA_SIZE, Long.valueOf(j5));
        insertOrReplaceWithoutException(NAME_METADATA_FILE_SIZE, Long.valueOf(j6));
        insertOrReplaceWithoutException(NAME_OFFSET, Long.valueOf(j7));
    }
    ...
    public void saveInstallParamForABUpdate(final String str, final long j3, final String str2, final long j5, final long j6, final long j7) {
        runInTransaction(new Runnable() { // from class: com.idm.fotaagent.database.room.data.repository.g
            @Override // java.lang.Runnable
            public final void run() {
                this.f6359c.lambda$saveInstallParamForABUpdate$1(str, j3, str2, j5, j6, j7);
            }
        });
    }
}
