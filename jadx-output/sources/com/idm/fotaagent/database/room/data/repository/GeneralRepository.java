...
public class GeneralRepository extends PropertyRepository.SpecificCategory {
    ...
    private static final String NAME_NEEDS_SEND_RESULT_FOR_MDM = "needsToSendResultForMDM";
    ...
    public /* synthetic */ void lambda$setDeviceRegistrationReportInfo$0(String str, long j3) {
        insertOrReplaceWithoutException(NAME_DEVICE_REGISTRATION_ERROR_CODE, str);
        insertOrReplaceWithoutException(NAME_DEVICE_REGISTRATION_REPORT_TIME, Long.valueOf(j3));
    }

    private void setNeedsSendResultForMdm(boolean z4) {
        insertOrReplaceWithoutException(NAME_NEEDS_SEND_RESULT_FOR_MDM, Boolean.valueOf(z4));
    }
    ...
    public void disableSendResultForMDM() {
        setNeedsSendResultForMdm(false);
    }

    public void enableSendResultForMDM() {
        setNeedsSendResultForMdm(true);
    }
    ...
    public boolean needsToSendResultForMDM() {
        return ((Boolean) getValueOf(NAME_NEEDS_SEND_RESULT_FOR_MDM, Boolean.FALSE)).booleanValue();
    }
    ...
    @Deprecated
    public void setBootTime(long j3) {
        insertOrReplaceWithoutException(NAME_BOOT_TIME, Long.valueOf(j3));
    }

    public void setDeviceRegistrationReportInfo(String str, long j3) {
        runInTransaction(new e(this, str, j3, 0));
    }
