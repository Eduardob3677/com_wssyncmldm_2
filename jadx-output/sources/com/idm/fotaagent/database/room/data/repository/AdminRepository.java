...
public class AdminRepository extends PropertyRepository.SpecificCategory {
    ...
    private static final String NAME_FEATURE_WIFI_ONLY_BEARER = "featureWifiOnlyBearer";
    ...
    public enum WifiOnlyBearer {
        WIFI_ONLY_BEARER_ON("On"),
        WIFI_ONLY_BEARER_OFF("Off");

        private final String description;

        WifiOnlyBearer(String str) {
            this.description = str;
        }
    ...
    public void deleteWifiOnlyBearer() {
        delete(NAME_FEATURE_WIFI_ONLY_BEARER);
    }
    ...
    public Optional<WifiOnlyBearer> getWifiOnlyBearer() {
        return getValueOf(NAME_FEATURE_WIFI_ONLY_BEARER);
    }
    ...
    public void setWifiOnlyBearer(WifiOnlyBearer wifiOnlyBearer) {
        insertOrReplaceWithoutException(NAME_FEATURE_WIFI_ONLY_BEARER, wifiOnlyBearer);
    }
