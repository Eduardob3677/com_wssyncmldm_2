...
public class PolicyRepository extends PropertyRepository.SpecificCategory {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$setVersionAndExpiredTime$0(String str, long j3) {
        setOtaVersion(str);
        setExpiredTime(j3);
    }
    ...
    public void setExpiredTime(long j3) {
        insertOrReplaceWithoutException(NAME_EXPIRED_TIME, Long.valueOf(j3));
    }
    ...
    public void setVersionAndExpiredTime(String str, long j3) {
        runInTransaction(new e(this, str, j3, 1));
    }
}
