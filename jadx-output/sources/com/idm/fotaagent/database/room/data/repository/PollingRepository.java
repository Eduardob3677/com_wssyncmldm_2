...
public class PollingRepository extends PropertyRepository.SpecificCategory {
    ...
    public void setFirstTime(long j3) {
        insertOrReplaceWithoutException(NAME_FIRST_TIME, Long.valueOf(j3));
    }

    public void setNextTime(long j3) {
        insertOrReplaceWithoutException(NAME_NEXT_TIME, Long.valueOf(j3));
    }
