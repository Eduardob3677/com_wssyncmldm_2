...
public abstract class Feature<T> {
    ...
    public static class MockDownloadType extends Feature<DownloadType> {
        public MockDownloadType(Context context) {
            super(context, DownloadType.values(), new a(0), new G2.b(9), new A2.a(7));
        }
    }
    ...
    public static class MockInstallPostponeType extends Feature<InstallPostponeType> {
        public MockInstallPostponeType(Context context) {
            super(context, (InstallPostponeType[]) Arrays.stream(new Byte[]{(byte) -1, (byte) 0, (byte) 1, (byte) 2, (byte) 3, (byte) 4, (byte) 5, (byte) 6, (byte) 7, (byte) 8, (byte) 9}).map(new G2.b(10)).toArray(new b(0)), new a(1), new G2.b(11), new A2.a(8));
        }
    ...
    public static class MockInstallType extends Feature<InstallType> {
        public MockInstallType(Context context) {
            super(context, InstallType.values(), new a(2), new G2.b(12), new A2.a(9));
        }
    }

    public static class MockServiceType extends Feature<ServiceType> {
        public MockServiceType(Context context) {
            super(context, ServiceType.values(), new a(3), new G2.b(13), new A2.a(10));
        }
    }

    public static class MockUpdateType extends Feature<UpdateType> {
        public MockUpdateType(Context context) {
            super(context, UpdateType.values(), new a(4), new G2.b(14), new A2.a(11));
        }
    }

    public static class MockWifiOnlyBearer extends Feature<AdminRepository.WifiOnlyBearer> {
        public MockWifiOnlyBearer(Context context) {
            super(context, AdminRepository.WifiOnlyBearer.values(), new a(5), new G2.b(15), new A2.a(12));
        }
    }
    ...
    public static class MockWifiOnlyDevice extends Feature<AdminRepository.WifiOnlyDevice> {
        public MockWifiOnlyDevice(Context context) {
            super(context, AdminRepository.WifiOnlyDevice.values(), new a(6), new G2.b(16), new A2.a(13));
        }
    }
    ...
    public Feature(Context context, T[] tArr, BiConsumer<AdminRepository, ? super T> biConsumer, Function<AdminRepository, Optional<? extends T>> function, Consumer<AdminRepository> consumer) {
        ...
        for (T t2 : tArr) {
            this.candidates.add(t2.toString());
        }
        int iIndexOf = this.candidates.indexOf(getValue().map(new G2.b(8)).orElse(""));
