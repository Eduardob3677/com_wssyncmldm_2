...
public class SettingsDatabaseManager {
    ...
    private static final String KEY_FOTA_SMLDM_BEARER = "SMLDM_BEARER";
    ...
    public static int getFotaBearerStatus(Context context) {
        try {
            int i5 = Settings.System.getInt(context.getContentResolver(), KEY_FOTA_SMLDM_BEARER, 0);
            Log.I("get fota bearer status : " + i5);
            return i5;
        } catch (Exception e5) {
            Log.printStackTrace(e5);
            return 0;
    ...
    public static void setLastCheckedData(Context context, long j3) {
        try {
            Settings.System.putLong(context.getContentResolver(), KEY_LAST_CHECKED_DATE, j3);
        } catch (Exception e5) {
            Log.printStackTrace(e5);
        }
    }
