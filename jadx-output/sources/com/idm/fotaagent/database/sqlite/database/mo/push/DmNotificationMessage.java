    ...
    public static class Trigger {
        ...
        public static class Body {
            ...
            public static final class TypeLengthValueDecoder {
                ...
                private TypeLengthValueDecoder(String str, int i5, byte b3, Decoder decoder) {
                    this.type = b3;
                ...
                /* JADX INFO: Access modifiers changed from: private */
                public static TypeLengthValueDecoder of(byte b3) {
                    for (TypeLengthValueDecoder typeLengthValueDecoder : values()) {
                        if (typeLengthValueDecoder.type == b3) {
                            return typeLengthValueDecoder;
                        }
                    }
                    throw new IllegalArgumentException(f.t(b3, "type: "));
                }
            ...
            private Body(byte[] bArr, int i5) {
                ...
                while (i7 + 2 < bArr.length) {
                    ...
                    try {
                        ...
                        TypeLengthValueField typeLengthValueFieldDecode = TypeLengthValueDecoder.of(b3).decode(bArr2);
        ...
        public static class Header {
            ...
            private static int setFrom(int i5) {
                if (i5 < 0 || i5 > 7) {
                    throw new IllegalArgumentException(f.t(i5, "beginIndex: "));
                }
                int i6 = 1;
                while (true) {
                    i5++;
            ...
            private static int setTo(int i5) {
                if (i5 < 1 || i5 > 8) {
                    throw new IllegalArgumentException(f.t(i5, "endIndex: "));
                }
                int i6 = 128;
                while (true) {
                    i5--;
