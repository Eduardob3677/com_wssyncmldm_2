...
public class IDMDatabaseManager implements Constants, IDMMoDatabaseConstants {
    ...
    public IDMDmExecInfo getExecInfo(String str) {
        ...
        try {
            Cursor cursorQuery = this.db.query(IDMDatabaseInterface.IDM_DB_EXECINFO, IDMDatabaseInterface.IDM_DB_EXECINFO_COLUMNS, "taskid = ?", new String[]{str}, null, null, null, null);
            try {
                if (cursorQuery.moveToNext()) {
    ...
    public IDMDatabaseServerInfo getReleaseServerInfo() throws Throwable {
        ...
        try {
            Cursor cursorQuery = this.db.query("profile", new String[]{"serverid", IDMDatabaseInterface.IDM_DB_PROFILE_ACTIVE}, "active = ?", new String[]{"1"}, null, null, null);
            try {
                if (cursorQuery.moveToNext()) {
