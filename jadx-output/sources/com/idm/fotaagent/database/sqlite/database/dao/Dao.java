...
public abstract class Dao<E> {
    ...
    public int deleteEntity(long j3) {
        return deleteEntity(String.valueOf(j3));
    }
    ...
    public boolean exists(long j3) {
        return exists(String.valueOf(j3));
    }
    ...
    public int getCount(long j3) {
        return getCount(String.valueOf(j3));
    }
    ...
    public E getEntity(long j3) {
        return getEntity(String.valueOf(j3));
    }
    ...
    public <T> T getValue(Dao<E>.Query query, Getter<T> getter, int i5, T t2) {
        try {
    ...
    public E getEntity(Dao<E>.Query query, E e5) {
        return (E) getValue(query, new Getter() { // from class: com.idm.fotaagent.database.sqlite.database.dao.c
            ...
            public final Object getAt(Cursor cursor, int i5) {
                return this.f6373a.lambda$getEntity$2(cursor, i5);
            }
        }, 0, e5);
    }

    public int update(String str, String str2, long j3) {
        ContentValues contentValues = new ContentValues();
