...
public class IDMSchedulerInfo implements Parcelable, IDMSchedulerInterface {
    ...
    public void idmSetIndex(long j3) {
        this.index = j3;
    }
    ...
    public IDMSchedulerInfo(long j3, IDMSchedulerInterface.IDM_SCHEDULE_TYPE idm_schedule_type, IDMActionInfo iDMActionInfo, Intent intent, int i5) {
        this.index = j3;
        this.initType = idm_schedule_type;
        this.actionInfo = iDMActionInfo;
        this.intent = intent;
