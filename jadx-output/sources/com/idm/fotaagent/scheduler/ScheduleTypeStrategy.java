...
public interface ScheduleTypeStrategy {
    ...
    public interface ActionInfo {
        ...
        static {
            final int i5 = 0;
            UPDATE_BY_PUSH_DATA = new ActionInfo() { // from class: com.idm.fotaagent.scheduler.e
            ...
            final int i6 = 1;
            UPDATE_BY_DM_PROFILE = new ActionInfo() { // from class: com.idm.fotaagent.scheduler.e
                @Override // com.idm.fotaagent.scheduler.ScheduleTypeStrategy.ActionInfo
                public final IDMActionInfo getActionInfoFrom(IDMSchedulerInfo iDMSchedulerInfo) {
                    switch (i6) {
                        case 0:
            ...
            final int i7 = 2;
            NO_CHANGE = new ActionInfo() { // from class: com.idm.fotaagent.scheduler.e
                @Override // com.idm.fotaagent.scheduler.ScheduleTypeStrategy.ActionInfo
                public final IDMActionInfo getActionInfoFrom(IDMSchedulerInfo iDMSchedulerInfo) {
                    switch (i7) {
                        case 0:
            ...
            final int i8 = 3;
            NULL = new ActionInfo() { // from class: com.idm.fotaagent.scheduler.e
                @Override // com.idm.fotaagent.scheduler.ScheduleTypeStrategy.ActionInfo
                public final IDMActionInfo getActionInfoFrom(IDMSchedulerInfo iDMSchedulerInfo) {
                    switch (i8) {
                        case 0:
    ...
    public interface Executor {
        ...
        public static abstract class AbstractExecutor implements Executor {
            private void deleteScheduleAndUpdateActionInfo(long j3, IDMActionInfo iDMActionInfo) {
                if (j3 > 0) {
                    Log.I("schedule index; " + j3);
                    new ScheduleInfoDao().deleteEntity(j3);
                }
