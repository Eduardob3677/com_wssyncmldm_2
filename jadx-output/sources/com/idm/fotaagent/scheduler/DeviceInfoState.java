...
public enum DeviceInfoState {
    ...
    public static class Element {
        ...
        static {
            ...
            }, new b(1)) { // from class: com.idm.fotaagent.scheduler.DeviceInfoState.Element.1
            ...
            SALES_CODE = new Element("SALES_CODE", 2, new com.idm.fotaagent.receiver.b(1, salesCode), new b(3));
            $VALUES = $values();
        }
        ...
        public DeviceInfoState state() {
            ...
            if (!TextUtils.isEmpty(str)) {
                ...
                return (DeviceInfoState) optionalApply.filter(new com.idm.core.ddf.a(str, 2)).map(new b(0)).orElseGet(new Supplier() { // from class: com.idm.fotaagent.scheduler.c
                    @Override // java.util.function.Supplier
                    public final Object get() {
                        return this.f6464a.lambda$state$2(str, optionalApply);
                    }
                });
            }
