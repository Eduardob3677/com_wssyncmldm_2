...
public class IDMSchedulerHandler {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                iArr2[IDMSchedulerInterface.IDM_SCHEDULE_TYPE.SCHEDULE_TYPE_SU_CANCEL_BY_MDM.ordinal()] = 1;
            ...
            try {
                $SwitchMap$com$idm$fotaagent$scheduler$interfaces$IDMSchedulerInterface$IDM_SCHEDULE_TYPE[IDMSchedulerInterface.IDM_SCHEDULE_TYPE.SCHEDULE_TYPE_SERVERINIT.ordinal()] = 4;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                $SwitchMap$com$idm$fotaagent$scheduler$interfaces$IDMSchedulerInterface$IDM_SCHEDULE_TYPE[IDMSchedulerInterface.IDM_SCHEDULE_TYPE.SCHEDULE_TYPE_DEVICEINIT.ordinal()] = 5;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                $SwitchMap$com$idm$fotaagent$scheduler$interfaces$IDMSchedulerInterface$IDM_SCHEDULE_TYPE[IDMSchedulerInterface.IDM_SCHEDULE_TYPE.SCHEDULE_TYPE_USERINIT.ordinal()] = 6;
    ...
    private IDMSchedulerHandler() {
        ...
        handlerThread.start();
        this.handler = new Handler(handlerThread.getLooper(), new Handler.Callback() { // from class: com.idm.fotaagent.scheduler.d
            @Override // android.os.Handler.Callback
            public final boolean handleMessage(Message message) {
                return this.f6467a.lambda$new$0(message);
            }
        });
    ...
    private void startSchedule(IDMSchedulerInfo iDMSchedulerInfo) {
        ...
        switch (AnonymousClass1.$SwitchMap$com$idm$fotaagent$scheduler$interfaces$IDMSchedulerInterface$IDM_SCHEDULE_TYPE[idm_schedule_typeIdmGetSchedulerInitType.ordinal()]) {
            case 1:
            case 2:
            case 3:
    ...
    public void idmSendMessage(IDMSchedulerInterface.IDM_SCHEDULE_EVENT idm_schedule_event, Object obj, long j3) {
        if (j3 < 0) {
        ...
        if (j3 > 0) {
            this.handler.sendMessageDelayed(messageObtainMessage, j3);
        } else {
    ...
    public void sendMessage(IDMSchedulerInterface.IDM_SCHEDULE_EVENT idm_schedule_event, Bundle bundle, long j3) {
        Message messageObtainMessage = this.handler.obtainMessage();
        messageObtainMessage.what = idm_schedule_event.ordinal();
