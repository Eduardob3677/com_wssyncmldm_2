...
public abstract class SoftwareUpdateCanceller implements FumoInitiator {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                $SwitchMap$com$idm$fotaagent$scheduler$interfaces$IDMSchedulerInterface$IDM_SCHEDULE_TYPE[IDMSchedulerInterface.IDM_SCHEDULE_TYPE.SCHEDULE_TYPE_SU_CANCEL_OR_RESET.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                $SwitchMap$com$idm$fotaagent$scheduler$interfaces$IDMSchedulerInterface$IDM_SCHEDULE_TYPE[IDMSchedulerInterface.IDM_SCHEDULE_TYPE.SCHEDULE_TYPE_SU_CANCEL_BY_SESSION_EXPIRATION.ordinal()] = 4;
    ...
    public static abstract class SuCancel extends SoftwareUpdateCanceller {
        ...
        public static class Mdm extends SuCancel {
            public Mdm() {
                super(IDMFumoExtInterface.IDM_FOTA_GENERIC_BLOCKED_MDM_UPDATE_FAILED, null);
            }
        }
