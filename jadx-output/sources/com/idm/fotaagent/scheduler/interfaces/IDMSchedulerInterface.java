...
public interface IDMSchedulerInterface {
    ...
    public static final class IDM_SCHEDULE_TYPE {
        ...
        public static final IDM_SCHEDULE_TYPE SCHEDULE_TYPE_SU_CANCEL_BY_MDM;
        ...
        private static /* synthetic */ IDM_SCHEDULE_TYPE[] $values() {
            return new IDM_SCHEDULE_TYPE[]{SCHEDULE_TYPE_SERVERINIT, SCHEDULE_TYPE_USERINIT, SCHEDULE_TYPE_DEVICEINIT, SCHEDULE_TYPE_USERINIT_RESUME, SCHEDULE_TYPE_SU_CANCEL_GENERIC, SCHEDULE_TYPE_SU_CANCEL_OR_RESET, SCHEDULE_TYPE_SU_CANCEL_BY_MDM, SCHEDULE_TYPE_SU_CANCEL_BY_SESSION_EXPIRATION};
        }
        ...
        static {
            ...
            SCHEDULE_TYPE_SU_CANCEL_BY_MDM = new IDM_SCHEDULE_TYPE("SCHEDULE_TYPE_SU_CANCEL_BY_MDM", 6, 16, actionInfo3, executor2);
            SCHEDULE_TYPE_SU_CANCEL_BY_SESSION_EXPIRATION = new IDM_SCHEDULE_TYPE("SCHEDULE_TYPE_SU_CANCEL_BY_SESSION_EXPIRATION", 7, 17, actionInfo3, executor2);
            $VALUES = $values();
