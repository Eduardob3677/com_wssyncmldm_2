...
public class SALogging {
    ...
    public static void setup(Application application) {
        new Thread(new b(26, application)).start();
    }
    ...
    public static void send(String str, String str2, String str3) {
        ...
        try {
            ...
            final int i5 = 0;
            optionalOfNullable.ifPresent(new Consumer() { // from class: u2.a
            ...
            final int i6 = 1;
            Optional.ofNullable(str3).ifPresent(new Consumer() { // from class: u2.a
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                    int i62 = i6;
                    LogBuilders.EventBuilder eventBuilder = eventId;
