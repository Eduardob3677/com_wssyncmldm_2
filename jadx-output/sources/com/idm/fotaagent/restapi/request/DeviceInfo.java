...
public interface DeviceInfo {
    ...
    public static class ForDeviceRegistration extends ForHeartBeat {
        ...
        static final String TAG_B2B_COPR_ID = "corpID";
        ...
        public String getCorpId() {
            return this.corpId.content().orElse("");
        }
        ...
        public void readDeviceInfo(Context context) {
            ...
            this.corpId = new Node(TAG_B2B_COPR_ID, corpId);
