...
public class TimestampForAuth {
    ...
    private boolean withinRange(long j3, long j5) {
        long j6 = VALUE_RANGE;
        if (j3 + j6 >= j5 && j3 - j6 <= j5) {
            return true;
        }
    ...
    public void fetchTimestamp() throws TimestampNotFetchedException, NumberFormatException {
        ...
        try {
            ...
            Log.H("initializeResult/currentServerTime = " + j3);
            new TimestampForAuth(this.context).setTimestamp(j3);
