...
public class PollingTimer {
    ...
    public void startPollingTimer(long j3) {
        long jCurrentTimeMillis = System.currentTimeMillis();
        Log.I("polling time is " + j3 + " and current time is " + jCurrentTimeMillis);
        if (j3 < jCurrentTimeMillis) {
            ...
            this.repository.setNextTime(j3);
        }
        ...
        alarmManager.setRepeating(0, j3, 3600000L, RestClientServiceType.POLLING.getPendingIntent(this.context));
        Log.D("Start polling timer: " + new Formatted.DateTimeForLog(j3));
    }
