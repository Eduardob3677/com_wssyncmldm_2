...
public abstract class NonAuthRestClient<T extends Response> extends BaseRestClient<T> {
    ...
    public NonAuthRestClient(Context context, String str, T t2, XmlParser xmlParser, StrategyFactory strategyFactory) {
        super(context, t2, xmlParser, strategyFactory);
        this.urlString = str;
    }
