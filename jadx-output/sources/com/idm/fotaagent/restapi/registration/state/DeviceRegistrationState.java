...
public class DeviceRegistrationState extends RegistrationState {
    ...
    public void postExecuteOnSuccess(Response.WithAttributes withAttributes) throws DeviceNotRegisteredException {
        ...
        try {
            new RegisteredDeviceRepository(applicationContext).save(forDeviceRegistration.getDeviceId(), forDeviceRegistration.getModelName(), forDeviceRegistration.getSalesCode(), forDeviceRegistration.getCorpId());
            ...
            MDMManager.sendRegistrationResultIfNeeded(0);
