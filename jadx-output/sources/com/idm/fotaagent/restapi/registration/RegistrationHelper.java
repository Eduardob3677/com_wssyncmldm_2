...
public class RegistrationHelper {
    ...
    public static void startDeviceRegistration(Context context, DeviceRegistrationRepository.Requester requester, long j3) {
        Log.V("");
        setRequester(context, requester);
        new SchedulableRegistration.WithoutUnregistration(context).start(j3);
    }
}
