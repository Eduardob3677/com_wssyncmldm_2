...
public abstract class Registration implements Serializable {
    ...
    public static /* synthetic */ JobInfo lambda$scheduleFallback$1(long j3, JobInfo.Builder builder) {
        return builder.setMinimumLatency(j3).setRequiredNetworkType(3).build();
    }
    ...
    private void scheduleFallback(long j3) {
        getFallback().scheduleTemplate(new c(0, j3));
    }
    ...
    public final void start(long j3) {
        ...
        initExecutor.execute(aVar, new BooleanSupplier() { // from class: D2.b
