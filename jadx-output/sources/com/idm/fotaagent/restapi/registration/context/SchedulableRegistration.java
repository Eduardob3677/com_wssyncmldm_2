...
public abstract class SchedulableRegistration extends Registration {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ JobInfo lambda$schedule$0(long j3, JobInfo.Builder builder) {
        return builder.setMinimumLatency(j3).build();
    }
    ...
    public void schedule(long j3) {
        ...
        Log.I("min latency: " + j3 + " ms");
        scheduleTemplate(new c(1, j3));
    }
