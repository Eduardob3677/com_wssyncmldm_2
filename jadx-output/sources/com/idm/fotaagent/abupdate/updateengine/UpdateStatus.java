...
public class UpdateStatus {
    ...
    public static class EngineStatus {
        ...
        public static EngineStatus of(int i5) {
            return (EngineStatus) Arrays.stream(values()).filter(new a(i5, 1)).findFirst().orElse(IDLE);
        }
    ...
    public static class InstallationStep {
        ...
        public static boolean containsExceptIdle(int i5) {
            return Arrays.stream(values()).filter(new a(i5, 2)).anyMatch(new com.idm.adapter.filesystem.a(1));
        }
        ...
        public static InstallationStep of(int i5) {
            return (InstallationStep) Arrays.stream(values()).filter(new a(i5, 4)).findFirst().orElse(IDLE);
        }

        public static Optional<Integer> ofNullable(int i5) {
            return Arrays.stream(values()).filter(new a(i5, 3)).filter(new com.idm.adapter.filesystem.a(2)).map(new b(5)).findFirst();
        }
