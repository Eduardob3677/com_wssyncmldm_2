...
public class ErrorCode {
    ...
    private static final String ERROR_CODE_METADATA_DOWNLOAD_FAILED = "553";
    ...
    public static final ErrorCode METADATA_DOWNLOAD_FAILED;
    ...
    static {
        ...
        SUCCESS = new ErrorCode("SUCCESS", i5, i5, dLResultCode) { // from class: com.idm.fotaagent.abupdate.updateengine.ErrorCode.1
            ...
            @Override // com.idm.fotaagent.abupdate.updateengine.ErrorCode
            public void reportForFailureToDLDM() {
            }
        ...
        PAYLOAD_MISMATCHED_TYPE_ERROR = new ErrorCode("PAYLOAD_MISMATCHED_TYPE_ERROR", 3, 6, dLResultCode);
        INSTALL_DEVICE_OPEN_ERROR = new ErrorCode("INSTALL_DEVICE_OPEN_ERROR", 4, 7, dLResultCode2);
        DOWNLOAD_TRANSFER_ERROR = new ErrorCode("DOWNLOAD_TRANSFER_ERROR", 5, 9, dLResultCode2);
        DLResultCode dLResultCode3 = DLResultCode.MISMATCHED_ATTRIBUTE;
        PAYLOAD_HASH_MISMATCH_ERROR = new ErrorCode("PAYLOAD_HASH_MISMATCH_ERROR", 6, 10, dLResultCode3);
        PAYLOAD_SIZE_MISMATCH_ERROR = new ErrorCode("PAYLOAD_SIZE_MISMATCH_ERROR", 7, 11, dLResultCode3);
        DOWNLOAD_PAYLOAD_VERIFICATION_ERROR = new ErrorCode("DOWNLOAD_PAYLOAD_VERIFICATION_ERROR", 8, 12, dLResultCode3);
        DOWNLOAD_NEW_PARTITION_INFO_ERROR = new ErrorCode("DOWNLOAD_NEW_PARTITION_INFO_ERROR", 9, 13, dLResultCode);
        ...
        SIGNED_DELTA_PAYLOAD_EXPECTED_ERROR = new ErrorCode("SIGNED_DELTA_PAYLOAD_EXPECTED_ERROR", 12, 17, dLResultCode);
        DOWNLOAD_PAYLOAD_PUBKEY_VERIFICATION_ERROR = new ErrorCode("DOWNLOAD_PAYLOAD_PUBKEY_VERIFICATION_ERROR", 13, 18, dLResultCode);
        ...
        DOWNLOAD_INVALID_METADATA_MAGIC_STRING = new ErrorCode("DOWNLOAD_INVALID_METADATA_MAGIC_STRING", 16, 21, dLResultCode3);
        DOWNLOAD_MANIFEST_PARSE_ERROR = new ErrorCode("DOWNLOAD_MANIFEST_PARSE_ERROR", 17, 23, dLResultCode);
        DOWNLOAD_METADATA_SIGNATURE_ERROR = new ErrorCode("DOWNLOAD_METADATA_SIGNATURE_ERROR", 18, 24, dLResultCode3);
        DOWNLOAD_METADATA_SIGNATURE_VERIFICATION_ERROR = new ErrorCode("DOWNLOAD_METADATA_SIGNATURE_VERIFICATION_ERROR", 19, 25, dLResultCode3);
        DOWNLOAD_METADATA_SIGNATURE_MISMATCH = new ErrorCode("DOWNLOAD_METADATA_SIGNATURE_MISMATCH", 20, 26, dLResultCode3);
        ...
        DOWNLOAD_OPERATION_HASH_MISMATCH = new ErrorCode("DOWNLOAD_OPERATION_HASH_MISMATCH", 23, 29, dLResultCode3);
        DOWNLOAD_INVALID_METADATA_SIZE = new ErrorCode("DOWNLOAD_INVALID_METADATA_SIZE", 24, 32, dLResultCode3);
        DOWNLOAD_OPERATION_HASH_MISSING_ERROR = new ErrorCode("DOWNLOAD_OPERATION_HASH_MISSING_ERROR", 25, 38, dLResultCode);
        DOWNLOAD_METADATA_SIGNATURE_MISSING_ERROR = new ErrorCode("DOWNLOAD_METADATA_SIGNATURE_MISSING_ERROR", 26, 39, dLResultCode);
        ...
        UNSUPPORTED_MAJOR_PAYLOAD_VERSION = new ErrorCode("UNSUPPORTED_MAJOR_PAYLOAD_VERSION", 29, 44, dLResultCode);
        UNSUPPORTED_MINOR_PAYLOAD_VERSION = new ErrorCode("UNSUPPORTED_MINOR_PAYLOAD_VERSION", 30, 45, dLResultCode);
        FILESYSTEM_VERIFIER_ERROR = new ErrorCode("FILESYSTEM_VERIFIER_ERROR", 31, 47, dLResultCode2);
        USER_CANCELED = new ErrorCode("USER_CANCELED", 32, 48, dLResultCode) { // from class: com.idm.fotaagent.abupdate.updateengine.ErrorCode.2
            @Override // com.idm.fotaagent.abupdate.updateengine.ErrorCode
            public void reportForFailureToDLDM() {
            }
        ...
        PAYLOAD_TIMESTAMP_ERROR = new ErrorCode("PAYLOAD_TIMESTAMP_ERROR", 33, 51, dLResultCode);
        UPDATED_BUT_NOT_ACTIVE = new ErrorCode("UPDATED_BUT_NOT_ACTIVE", 34, 52, dLResultCode) { // from class: com.idm.fotaagent.abupdate.updateengine.ErrorCode.3
            @Override // com.idm.fotaagent.abupdate.updateengine.ErrorCode
            public String getDmResultCode() {
                return "200";
            }
        ...
        NOT_ENOUGH_SPACE = new ErrorCode("NOT_ENOUGH_SPACE", 36, 60, DLResultCode.INSUFFICIENT_STORAGE) { // from class: com.idm.fotaagent.abupdate.updateengine.ErrorCode.4
            @Override // com.idm.fotaagent.abupdate.updateengine.ErrorCode
        ...
        UPDATE_PROCESSING = new ErrorCode("UPDATE_PROCESSING", 40, 65, dLResultCode);
        UPDATE_ALREADY_INSTALLED = new ErrorCode("UPDATE_ALREADY_INSTALLED", 41, 66, dLResultCode);
        MERGE_NEEDS_REBOOT = new ErrorCode("MERGE_NEEDS_REBOOT", 42, -1, dLResultCode2) { // from class: com.idm.fotaagent.abupdate.updateengine.ErrorCode.5
            @Override // com.idm.fotaagent.abupdate.updateengine.ErrorCode
            public String getDmResultCode() {
                return ErrorCode.ERROR_CODE_MERGE_NEEDS_REBOOT;
            }
        };
        SLOT_NOT_CHANGED = new ErrorCode("SLOT_NOT_CHANGED", 43, -2, dLResultCode2) { // from class: com.idm.fotaagent.abupdate.updateengine.ErrorCode.6
            @Override // com.idm.fotaagent.abupdate.updateengine.ErrorCode
            public String getDmResultCode() {
                return ErrorCode.ERROR_CODE_SLOT_NOT_CHANGED;
            }
        };
        METADATA_DOWNLOAD_FAILED = new ErrorCode("METADATA_DOWNLOAD_FAILED", 44, -3, dLResultCode2) { // from class: com.idm.fotaagent.abupdate.updateengine.ErrorCode.7
            @Override // com.idm.fotaagent.abupdate.updateengine.ErrorCode
            public String getDmResultCode() {
                return ErrorCode.ERROR_CODE_METADATA_DOWNLOAD_FAILED;
            }
        };
        REBOOT_FAILED = new ErrorCode("REBOOT_FAILED", 45, -4, dLResultCode2) { // from class: com.idm.fotaagent.abupdate.updateengine.ErrorCode.8
            @Override // com.idm.fotaagent.abupdate.updateengine.ErrorCode
            public String getDmResultCode() {
    ...
    public static ErrorCode of(int i5) {
        Log.I("errorCode : " + i5);
        return (ErrorCode) Stream.of((Object[]) values()).filter(new a(i5, 0)).findFirst().orElse(ERROR);
    }
    ...
    public void reportToDL() {
        ...
        new DLReporter.ForFailure().report(taskId, this.dlResultCode.getMessage());
    }
    ...
    public void showDialogIfPossible() {
        ...
        if (new ActionInfoDao().getUiMode() == 1) {
