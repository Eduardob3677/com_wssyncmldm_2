...
public class EnablerManager {
    ...
    public void cancelAndShowDialog() {
        ...
        new IDMFumoExecuteHandler(getTaskId()).executeIfPossible(IDMCallbackStatusInterface.IDM_DL_STATE_DOWNLOAD_IN_CANCEL, 3);
    }

    private void checkFumoStatus(int i5) {
        int fumoStatus = getFumoStatus();
        if (fumoStatus != i5) {
            throw new IllegalStateException(f.t(fumoStatus, "unexpected FumoStatus : "));
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$applyPayload$1(long j3) {
        try {
            checkFumoStatus(30);
            this.updateEngineManager.applyPayload(j3);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$suspend$2() {
        try {
            checkFumoStatus(IDMCallbackStatusInterface.IDM_DL_STATE_DOWNLOAD_PAUSE);
            this.updateEngineManager.cancel();
        } catch (IllegalStateException e5) {
            Log.printStackTrace(e5);
            cancelAndShowDialog();
    ...
    public void applyPayload(long j3) {
        this.handler.post(new c(0, j3, this));
    }
    ...
    public void bind() {
        ...
        handler.post(new a(3, updateEngineManager));
    }
    ...
    public void suspend() {
        setPendingPause();
        this.handler.post(new a(2, this));
    }
