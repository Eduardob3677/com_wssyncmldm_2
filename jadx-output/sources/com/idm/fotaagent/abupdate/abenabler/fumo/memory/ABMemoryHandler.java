...
public class ABMemoryHandler implements MemoryHandler {
    ...
    public void allocateAndCheckStorage(String str) throws InsufficientMemoryToAllocateException, AllocateFailedException {
        ...
        long j3 = jAllocateSpaceAndGetRequiredFreeMemory + requiredDataMargin + metadataFileSize;
        if (availableBytesAtData >= j3) {
            return;
        }
        long j5 = j3 - availableBytesAtData;
    ...
    public void checkStorage() throws InsufficientMemoryToAllocateException {
        ...
        long j3 = requiredDataMargin - availableBytesAtData;
        InsufficientMemoryDialogModel.setRequiredBytes(j3);
        throw new InsufficientMemoryToAllocateException("Memory NOT INSUFFICIENT for VAB", j3);
    }
