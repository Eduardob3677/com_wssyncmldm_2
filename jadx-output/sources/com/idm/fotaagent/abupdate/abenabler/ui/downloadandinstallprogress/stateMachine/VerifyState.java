...
public class VerifyState extends UpdateState {
    static final double WEIGHT_VERIFY = 0.9d;
    ...
    @Override // com.idm.fotaagent.abupdate.abenabler.ui.downloadandinstallprogress.stateMachine.UpdateState
    public String getActiveProgressViewTitle() {
        return this.context.getString(R.string.STR_VERIFYING_PROGRESSBAR_AB);
    }

    @Override // com.idm.fotaagent.abupdate.abenabler.ui.downloadandinstallprogress.stateMachine.UpdateState
    public String getInactiveProgressViewTitleForOnExit() {
        return this.context.getString(R.string.STR_VERIFYING_PROGRESSBAR_AB);
    }

    @Override // com.idm.fotaagent.abupdate.abenabler.ui.downloadandinstallprogress.stateMachine.UpdateState
    public String getInactiveProgressViewTitleForPause() {
        return this.context.getString(R.string.STR_VERIFICATION_PROGRESSBAR_AB);
    }

    @Override // com.idm.fotaagent.abupdate.abenabler.ui.downloadandinstallprogress.stateMachine.UpdateState
    public int getOnExitPercent() {
        return (int) (super.getOnExitPercent() * WEIGHT_VERIFY);
    }
