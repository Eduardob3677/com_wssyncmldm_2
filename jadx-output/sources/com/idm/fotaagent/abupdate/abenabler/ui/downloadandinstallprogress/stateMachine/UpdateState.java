...
public abstract class UpdateState {
    ...
    public abstract String getActiveProgressViewTitle();
    ...
    public abstract String getInactiveProgressViewTitleForOnExit();

    public abstract String getInactiveProgressViewTitleForPause();
    ...
    public ProgressViewParams getParamForOnEntry() {
        return new ProgressViewParams.Builder(getProgressViewTitle()).withTitleStyle(R.style.TextAppearance_Widget_TextView_Progress_Body_AB_Step_Activate).build();
    }

    public ProgressViewParams getParamForOnExit() {
        return new ProgressViewParams.Builder(getInactiveProgressViewTitleForOnExit()).withPercent(getOnExitPercent()).build();
    }

    public ProgressViewParams getParamForRefresh(int i5) {
        return new ProgressViewParams.Builder(getProgressViewTitle()).withPercent(convertPercent(i5)).build();
    }
    ...
    public String getProgressViewTitle() {
        return isPauseStatus() ? getInactiveProgressViewTitleForPause() : getActiveProgressViewTitle();
    }
