...
public class FileManager {
        ...
        try {
            Arrays.stream(fileArrListFiles).filter(new Predicate() { // from class: com.idm.fotaagent.utils.storage.a
                ...
                public final boolean test(Object obj) {
                    return this.f6473a.lambda$clearDirectory$0(strArr, (File) obj);
                }
            }).forEach(new com.idm.fotaagent.enabler.ui.notification.manager.a(this, strArr, 1));
        } catch (Exception e5) {
    ...
    public boolean shouldExclude(String str, String... strArr) {
        ...
        return stream.filter(new com.idm.core.ddf.a(str, 3)).peek(new A2.a(25)).count() > 0;
    }
