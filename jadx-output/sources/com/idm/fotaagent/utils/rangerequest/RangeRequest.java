...
public abstract class RangeRequest {
    ...
    public interface OnFileLengthChangedListener {
        void onFileLengthChanged(long j3);
    }
    ...
    public static class Range {
        ...
        public Range(long j3, long j5) {
            if (j3 < 0) {
                throw new IllegalArgumentException("start(" + j3 + ") should be greater than or equal to zero");
            }
            if (j5 < 0) {
                throw new IllegalArgumentException("end(" + j5 + ") should be greater than or equal to zero: ");
            }
            if (j3 <= j5) {
                this.start = j3;
                this.end = j5;
            ...
            throw new IllegalArgumentException("start(" + j3 + ") should be less than or equal to end(" + j5 + ")");
        }
