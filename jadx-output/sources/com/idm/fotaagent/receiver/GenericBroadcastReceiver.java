...
public class GenericBroadcastReceiver extends SafeBroadcastReceiver {
    ...
    private void startPollingIfNeeded(long j3) {
        ...
        switch (action) {
            ...
            case "android.intent.action.BOOT_COMPLETED":
                ...
                new Thread(new Runnable(this) { // from class: com.idm.fotaagent.receiver.a
                    ...
                    public final /* synthetic */ GenericBroadcastReceiver f6441d;
                    ...
                    public final void run() {
                        int i6 = i5;
                        GenericBroadcastReceiver genericBroadcastReceiver = this.f6441d;
                        switch (i6) {
                            case 0:
    ...
    public void updatePostponeIfNeeded(long j3) {
        ...
        if (!postponeRepository.isNone() && postponeRepository.alarmTime() >= j3) {
