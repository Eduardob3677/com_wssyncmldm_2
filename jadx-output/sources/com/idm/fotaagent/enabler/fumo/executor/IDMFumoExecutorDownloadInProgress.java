...
public class IDMFumoExecutorDownloadInProgress extends IDMFumoExecutor {
    ...
    public void checkMemoryAndStartDownloading() {
        try {
            ...
            new IDMFumoExecuteHandler(this.taskId).executeIfPossible(35, 2);
        } catch (InvalidStateException e6) {
            Log.printStackTrace(e6);
            new IDMFumoExecuteHandler(this.taskId).executeIfPossible(35, 8);
        }
    }
    ...
    public void idmFumoStart() {
        ...
        Policies.ForDownload.getExceptional().ifThrown(downloadNotAllowed.act(), downloadNotAllowed.getExceptionClass()).orElse(new D1.b(20, this));
    }
