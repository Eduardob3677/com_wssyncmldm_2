...
public class IDMFumoExecutorFumoStart extends IDMFumoExecutor {
    ...
    public void callDownloadYesNo() {
        Log.I("");
        this.fotaJobRepository.descriptionContent().ifPresent(new A2.a(15));
    ...
    private void idmCallbackExecuteDownloadAndUpdate(IDMDDDataInfo iDMDDDataInfo) {
        String strConvertDlResultCodeToDmResultCode;
        Log.I("");
        try {
            ...
            Policies.ForDownload.getExceptional().ifThrown(downloadNotAllowed.act(), downloadNotAllowed.getExceptionClass()).orElse(new D1.b(21, this));
            ...
            if (e5 instanceof DownloadDescriptorException) {
                ...
                strConvertDlResultCodeToDmResultCode = EnablerUtils.convertDlResultCodeToDmResultCode(downloadDescriptorException.getErrorCode());
            } else {
                strConvertDlResultCodeToDmResultCode = EnablerUtils.convertDlResultCodeToDmResultCode(6);
            }
            new IDMFumoExecuteHandler(this.taskId).executeIfPossible(IDMCallbackStatusInterface.IDM_DL_STATE_DOWNLOAD_FAILED_REPORTING, strConvertDlResultCodeToDmResultCode);
        }
    }
    ...
    public void updateActionInfo(String str) {
        ...
        int i5 = this.nDownloadType;
        this.actionInfoDao.setDownloadDescriptorUrl(iDMMoDatabaseManagerIdmGetMoDatabaseManager.idmMoGetNodeInfo(this.actionInfoDao.getServerId(), i5 == 1 ? AbstractC0432c.h(strIdmMoGetxFumo, "/DownloadAndUpdate/PkgURL") : i5 == 2 ? AbstractC0432c.h(strIdmMoGetxFumo, "/Download/PkgURL") : "").idmMoNodeGetValue());
