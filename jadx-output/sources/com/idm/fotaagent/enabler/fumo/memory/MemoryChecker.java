...
abstract class MemoryChecker {
    ...
    public static class ForCache extends MemoryChecker {
        ...
        public long getRequiredMarginForDownload() {
            ...
            long j3 = objectSize + cacheMargin;
            Log.I("Cache - delta size : " + objectSize + ", cache margin : " + cacheMargin + ", sum : " + j3);
            return j3;
        }
        ...
        @Override // com.idm.fotaagent.enabler.fumo.memory.MemoryChecker
        public void setRequiredBytesIfNeeded(long j3) {
        }
    }
    ...
    public static class ForData extends MemoryChecker {
        ...
        @Override // com.idm.fotaagent.enabler.fumo.memory.MemoryChecker
        public void setRequiredBytesIfNeeded(long j3) {
            InsufficientMemoryDialogModel.setRequiredBytes(j3);
        }
    }
    ...
    public abstract void setRequiredBytesIfNeeded(long j3);
    ...
    private void checkDownloadable(long j3) throws InsufficientMemoryToDownloadException {
        long freeSize = getFreeSize();
        if (j3 < freeSize) {
            return;
        }
        Log.I("### need : " + j3 + " but now has : " + freeSize + ") ... Memory INSUFFICIENT...");
        setRequiredBytesIfNeeded(j3 - freeSize);
