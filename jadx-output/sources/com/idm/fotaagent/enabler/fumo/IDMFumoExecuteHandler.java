...
public class IDMFumoExecuteHandler {
    ...
    public int getExecCommand() {
        return ((Integer) Optional.ofNullable(IDMDatabaseManager.getInstance().getExecInfo(this.taskId)).map(new Function() { // from class: com.idm.fotaagent.enabler.fumo.a
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                return Integer.valueOf(this.f6378a.convertToUpdateType((IDMDmExecInfo) obj));
            }
        }).filter(new b()).orElseThrow(new c())).intValue();
    }
