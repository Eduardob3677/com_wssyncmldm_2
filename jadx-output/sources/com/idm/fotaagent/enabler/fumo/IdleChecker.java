...
public class IdleChecker {
    ...
    public static abstract class DeviceStatus {
        ...
        public enum AnonymousClass4 extends DeviceStatus {
            ...
            public static /* synthetic */ Boolean lambda$runs$0(Integer num) {
                Log.I("Dex enabled : " + num);
                return Boolean.valueOf(num.intValue() == 4 || num.intValue() == 3);
            }

            @Override // com.idm.fotaagent.enabler.fumo.IdleChecker.DeviceStatus
            public boolean runs(Context context) {
                return ((Boolean) Optional.ofNullable((SemDesktopModeManager) context.getSystemService("desktopmode")).map(new Function() { // from class: com.idm.fotaagent.enabler.fumo.h
                    @Override // java.util.function.Function
                    public final Object apply(Object obj) {
                        return ((SemDesktopModeManager) obj).getDesktopModeState();
                    }
                }).map(new Function() { // from class: com.idm.fotaagent.enabler.fumo.i
                    @Override // java.util.function.Function
                    public final Object apply(Object obj) {
                        return Integer.valueOf(((SemDesktopModeState) obj).getEnabled());
                    }
                }).map(new Function() { // from class: com.idm.fotaagent.enabler.fumo.j
                    @Override // java.util.function.Function
                    public final Object apply(Object obj) {
                        return IdleChecker.DeviceStatus.AnonymousClass4.lambda$runs$0((Integer) obj);
                    }
    ...
    private boolean isDeviceIdle() {
        ...
        Stream.of((Object[]) DeviceStatus.values()).filter(new Predicate() { // from class: com.idm.fotaagent.enabler.fumo.f
            ...
            public final boolean test(Object obj) {
                return this.f6386a.lambda$isDeviceIdle$0((IdleChecker.DeviceStatus) obj);
            }
        }).findAny().ifPresent(new Consumer() { // from class: com.idm.fotaagent.enabler.fumo.g
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                this.f6387c.lambda$isDeviceIdle$1((IdleChecker.DeviceStatus) obj);
            }
        });
        return !r0.isPresent();
    }
    ...
    public boolean isCallIdle() {
        ...
        if (telephonyManager != null) {
            ...
            B.f.D("Call state: ", callStateForSubscription);
        } else {
