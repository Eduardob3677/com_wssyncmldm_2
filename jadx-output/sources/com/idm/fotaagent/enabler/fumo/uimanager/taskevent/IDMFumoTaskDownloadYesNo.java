...
public class IDMFumoTaskDownloadYesNo extends IDMFumoTaskCommon {
    ...
    public boolean allowsToDownload() {
        ...
        if (initType == 2) {
            if (pushUiMode != 1 && pushUiMode != 2) {
                if (pushUiMode != 4) {
                    ...
                    new IDMFumoExecuteHandler(this.taskId).executeIfPossible(35, 13);
        ...
        new IDMFumoExecuteHandler(this.taskId).executeIfPossible(IDMCallbackStatusInterface.IDM_DL_STATE_DOWNLOAD_IN_CANCEL, 3);
        return false;
    }
