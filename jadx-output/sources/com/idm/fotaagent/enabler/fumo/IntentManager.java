...
public class IntentManager {
    ...
    public static void sendFotaStatus(ResultStatus resultStatus) {
        ...
        new IntentBuilder(IntentActions.IDM_INTENT_MDM_UPDATE_RESULT).setFlags(16777248).setExtra("result", resultStatus.status()).sendBroadcast();
    }
    ...
    public static void sendMDMUnregister() {
        Log.I("sendMDMUnregister");
        new IntentBuilder(IntentActions.IDM_INTENT_MDM_UNREGISTER).setFlags(16777248).sendBroadcast();
    }
