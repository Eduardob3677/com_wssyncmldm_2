...
public abstract class UpdateReporter {
    ...
    private void startRestClient(IDMActionInfo iDMActionInfo, RestRequest restRequest) {
        IDMProviderService.idmRestStart(getContext(), iDMActionInfo, new IDMAdapterImpl(iDMActionInfo.idmGetSessionId(), iDMActionInfo.idmGetAppId()), getCallback(), restRequest);
    }
