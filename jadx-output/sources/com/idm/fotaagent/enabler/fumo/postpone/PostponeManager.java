...
public class PostponeManager {
    ...
    public static void set(PostponeType postponeType, long j3, String str) {
        set(postponeType, j3, PostponeReason.NONE, str);
    }
    ...
    public static void set(PostponeType postponeType, long j3, PostponeReason postponeReason, String str) {
        ...
        new PostponeTimer(getContext()).start(j3, postponeType, str);
        postponeType.setDBAndUpdateNotification(j3, str);
    }
}
