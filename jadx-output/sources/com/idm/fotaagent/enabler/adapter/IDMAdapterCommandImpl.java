...
public class IDMAdapterCommandImpl implements IDMDmCommandInterface {
    ...
    static final String PATH_CORPID = "./DevInfo/Ext/CorpId";
    ...
    static final String PATH_DEVNETWORKCONNTYPE = "./DevInfo/Ext/DevNetworkConnType";
    ...
    static final String PATH_TARGETVERSION = "./DevInfo/Ext/TargetVersion";
    ...
    private String processGet(IDMActionInfo iDMActionInfo, String str) {
        ...
        switch (str) {
            ...
            case "./DevInfo/Ext/TargetVersion":
                return new MDMInfo().getTargetVersion();
            case "./DevInfo/Ext/CorpId":
                return new RegisteredDeviceRepository(getContext()).getCorpId().orElse(null);
            default:
