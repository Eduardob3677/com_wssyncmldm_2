...
public class IDMAdapterDeviceInfoImpl extends IDMDeviceInfoAdapter {
    ...
    public static /* synthetic */ boolean lambda$idmGetExtendDevInfo$0(String str) {
        return str.length() > 0;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$idmGetExtendDevInfo$1(ArrayList arrayList, String str) {
        arrayList.add("./DevInfo/Ext/CorpId");
        arrayList.add("./DevInfo/Ext/TargetVersion");
    }
    ...
    public ArrayList<String> idmGetExtendDevInfo() {
        ...
        arrayList.add("./DevInfo/Ext/DevNetworkConnType");
        ...
        new RegisteredDeviceRepository(IDMApplication.idmGetContext()).getCorpId().filter(new a(5)).ifPresent(new c(2, arrayList));
