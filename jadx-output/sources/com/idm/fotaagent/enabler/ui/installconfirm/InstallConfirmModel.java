...
public class InstallConfirmModel {
    ...
    private String getExpirationTimeString(Context context) {
        long jLongValue = ((Long) Optional.ofNullable((JobScheduler) context.getSystemService(JobScheduler.class)).map(new G2.b(28)).map(new G2.b(29)).map(new h(11)).orElse(-1L)).longValue();
