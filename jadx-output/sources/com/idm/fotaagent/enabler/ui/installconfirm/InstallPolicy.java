...
public class InstallPolicy {
    ...
    public synchronized void enableFirstNetInstallIfNeeded(final Context context) {
        Optional.ofNullable(new ActionInfoDao().getEntity()).map(new d(0)).filter(new com.idm.adapter.filesystem.a(8)).ifPresent(new Consumer() { // from class: com.idm.fotaagent.enabler.ui.installconfirm.e
