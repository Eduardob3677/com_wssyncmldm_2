...
public class CopyAndUpdateTrigger {
    ...
    public synchronized void start() {
        ...
        final int i5 = 0;
        this.copyingTask = scheduledExecutorServiceNewSingleThreadScheduledExecutor.scheduleAtFixedRate(new Runnable(this) { // from class: com.idm.fotaagent.enabler.ui.admin.main.hidden.executor.a

            /* renamed from: d, reason: collision with root package name */
            public final /* synthetic */ CopyAndUpdateTrigger f6412d;
            ...
            public final void run() {
                int i6 = i5;
                CopyAndUpdateTrigger copyAndUpdateTrigger = this.f6412d;
                switch (i6) {
                    case 0:
