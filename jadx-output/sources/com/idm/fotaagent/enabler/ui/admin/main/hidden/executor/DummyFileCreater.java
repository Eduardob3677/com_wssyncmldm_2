...
public class DummyFileCreater {
    ...
    public DummyFileCreater(Context context, String str, long j3) {
        this.context = context;
        this.fileName = str;
        this.total = (int) (j3 / 1048576);
    }
    ...
    public synchronized void start() {
        ...
        this.creatingTask = scheduledExecutorServiceNewSingleThreadScheduledExecutor.scheduleAtFixedRate(new b(this, 0), 0L, REFRESH_STEP, TimeUnit.SECONDS);
