...
public class PostponeDialog extends r implements PostponeContractor.View {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$onCreateDialog$2(DialogInterfaceOnClickListenerC0419b dialogInterfaceOnClickListenerC0419b, DialogInterface dialogInterface) {
        dialogInterfaceOnClickListenerC0419b.d(-1).setOnClickListener(new d(0, dialogInterfaceOnClickListenerC0419b));
    }
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        final DialogInterfaceOnClickListenerC0419b dialogInterfaceOnClickListenerC0419b = new DialogInterfaceOnClickListenerC0419b(activity, bVar, i7, i6, DateFormat.is24HourFormat(getActivity()));
        dialogInterfaceOnClickListenerC0419b.setTitle(this.presenter.getTitle());
        String message = this.presenter.getMessage();
        C0405i c0405i = dialogInterfaceOnClickListenerC0419b.f6776h;
        c0405i.f = message;
        TextView textView = c0405i.f6736B;
        if (textView != null) {
            textView.setText(message);
        }
        c0405i.d(-1, getString(R.string.STR_BTN_DONE), dialogInterfaceOnClickListenerC0419b);
        c0405i.d(-2, getContext().getString(R.string.STR_BTN_CANCEL), dialogInterfaceOnClickListenerC0419b);
        dialogInterfaceOnClickListenerC0419b.setOnShowListener(new DialogInterface.OnShowListener() { // from class: A2.c
            @Override // android.content.DialogInterface.OnShowListener
            public final void onShow(DialogInterface dialogInterface) {
                PostponeDialog.lambda$onCreateDialog$2(dialogInterfaceOnClickListenerC0419b, dialogInterface);
            }
        });
        try {
            dialogInterfaceOnClickListenerC0419b.getWindow().setSoftInputMode(16);
        } catch (NullPointerException e5) {
            Log.printStackTrace(e5);
        }
        setAnchorView(dialogInterfaceOnClickListenerC0419b);
        return dialogInterfaceOnClickListenerC0419b;
    }
    ...
    public void onDismiss(DialogInterface dialogInterface) {
        ...
        if (getParentFragmentManager().B(ReschedulePostponeActivity.TAG_RESCHEDULE_POSTPONE_DIALOG) != null) {
            ...
            Optional.ofNullable(this.refreshListener).ifPresent(new a(0));
