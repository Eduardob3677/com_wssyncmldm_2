...
public abstract class SoftwareUpdateInformation extends ContentInjector.Model.TitleAndBullets {
    ...
    public static class Content {
        ...
        public Content(int i5, String str, Double d2, String str2, String str3, String str4) {
    ...
    private static CharSequence getFwSizeDescription(Double d2) {
        if (d2 != null) {
            return String.format(getContext().getString(R.string.STR_UPDATE_SIZE_MB), String.format("%.2f", d2));
        }
        return null;
    }
