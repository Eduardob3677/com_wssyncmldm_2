...
public interface DescriptionBody {
    public static final DescriptionBody FOR_NEW = new E2.a(29);
    public static final DescriptionBody FOR_LAST = new a(0);
    public static final DescriptionBody FOR_TWO_DEPTH = new a(1);
