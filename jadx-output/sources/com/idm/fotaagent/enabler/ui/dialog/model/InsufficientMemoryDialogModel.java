...
public class InsufficientMemoryDialogModel extends IDMUIDialogModel.Base {
    ...
    public static void setRequiredBytes(long j3) {
        requiredBytes = j3;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static String sizeWithUnit(long j3) {
        if (j3 < 1) {
        ...
        double d2 = j3;
        int iLog10 = (int) (Math.log10(d2) / Math.log10(1000.0d));
        StringBuilder sb = new StringBuilder();
        sb.append(new DecimalFormat(iLog10 <= 2 ? "###0" : "###0.##").format(d2 / Math.pow(1000.0d, iLog10)));
        sb.append(" ");
