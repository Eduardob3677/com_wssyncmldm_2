...
public enum IDMUIManager {
    ...
    IDMUIManager() {
        ...
        this.handler = new Handler(handlerThread.getLooper(), new Handler.Callback() { // from class: com.idm.fotaagent.enabler.ui.f
            ...
            public final boolean handleMessage(Message message) {
                return this.f6424a.lambda$new$0(message);
            }
        });
    }
    ...
    private void idmHandleMessage(Message message) throws InterruptedException {
        try {
            ...
            long j3 = 1000 - (jElapsedRealtime - this.lastRequestTimeForUi);
            if (j3 > 0) {
                try {
    ...
    public void sendDelayedDialogMessage(IDMUIEventInterface.UIDIALOG uidialog, BundleWrapper bundleWrapper, long j3) {
        if (j3 < 0) {
