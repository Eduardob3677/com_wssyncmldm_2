...
public final /* synthetic */ class f implements Callable {
    ...
    public /* synthetic */ Context f6234a;

    /* renamed from: b, reason: collision with root package name */
    public /* synthetic */ Intent f6235b;
    ...
    public final Object call() {
        ...
        Intent intent = this.f6235b;
        p pVarY = p.y();
        pVarY.getClass();
        if (Log.isLoggable("FirebaseMessaging", 3)) {
            Log.d("FirebaseMessaging", "Starting service");
        }
        ((ArrayDeque) pVarY.f6260g).offer(intent);
        Intent intent2 = new Intent("com.google.firebase.MESSAGING_EVENT");
        intent2.setPackage(context.getPackageName());
        synchronized (pVarY) {
            try {
                str = (String) pVarY.f6258d;
                if (str == null) {
                    ...
                    if (resolveInfoResolveService == null || (serviceInfo = resolveInfoResolveService.serviceInfo) == null) {
                        ...
                        if (context.getPackageName().equals(serviceInfo.packageName) && (str2 = serviceInfo.name) != null) {
                            if (str2.startsWith(IDMMoInterface.IDM_MO_ROOT_PATH)) {
                                ...
                                pVarY.f6258d = strValueOf2.length() != 0 ? strValueOf.concat(strValueOf2) : new String(strValueOf);
                            } else {
                                pVarY.f6258d = serviceInfo.name;
                            }
                            str = (String) pVarY.f6258d;
                        }
        ...
        try {
            if (pVarY.A(context)) {
                componentNameStartService = A.a(context, intent2);
            } else {
