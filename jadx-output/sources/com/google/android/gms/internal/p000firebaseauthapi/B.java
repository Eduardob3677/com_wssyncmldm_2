...
public abstract class B {
    ...
    public static final Class f5333a;

    /* renamed from: b, reason: collision with root package name */
    public static final E f5334b;

    /* renamed from: c, reason: collision with root package name */
    public static final E f5335c;

    /* renamed from: d, reason: collision with root package name */
    public static final E f5336d;
    ...
    public static int F(int i5, List list, A a3) {
        int size = list.size();
        if (size == 0) {
            return 0;
        }
        ...
        for (int i6 = 0; i6 < size; i6++) {
            iT0 += f5.t0(i5, (U4) list.get(i6), a3);
        }
        return iT0;
    }
    ...
    public static int K(int i5, A a3, Object obj) {
        U4 u42 = (U4) obj;
        int iA0 = f5.a0(i5 << 3);
        m5 m5Var = (m5) u42;
        int iE = m5Var.zzd;
        ...
        return f.r(iE, iE, iA0);
    }

    public static int L(int i5, List list, A a3) {
        int size = list.size();
        if (size == 0) {
            return 0;
        }
    ...
    public static int Q(int i5, List list) {
        ...
        if (list instanceof InterfaceC0273i) {
            ...
            while (i6 < size) {
                Object objK = interfaceC0273i.k(i6);
    ...
    public static void b(E e5, Object obj, Object obj2) {
        e5.getClass();
        m5 m5Var = (m5) obj;
        D d2 = m5Var.zzc;
        D d5 = ((m5) obj2).zzc;
        if (!d5.equals(D.f)) {
            int i5 = d2.f5350a + d5.f5350a;
            int[] iArrCopyOf = Arrays.copyOf(d2.f5351b, i5);
            System.arraycopy(d5.f5351b, 0, iArrCopyOf, d2.f5350a, d5.f5350a);
            Object[] objArrCopyOf = Arrays.copyOf(d2.f5352c, i5);
            System.arraycopy(d5.f5352c, 0, objArrCopyOf, d2.f5350a, d5.f5350a);
            d2 = new D(i5, iArrCopyOf, objArrCopyOf, true);
        }
        m5Var.zzc = d2;
    }
    ...
    public static void d(int i5, List list, C0303n c0303n, boolean z4) {
        if (list == null || list.isEmpty()) {
            return;
        }
        f5 f5Var = (f5) c0303n.f5655d;
        int i6 = 0;
        if (!z4) {
            while (i6 < list.size()) {
    ...
    public static void e(int i5, List list, C0303n c0303n) {
        if (list == null || list.isEmpty()) {
            return;
        }
        c0303n.getClass();
        for (int i6 = 0; i6 < list.size(); i6++) {
            ((f5) c0303n.f5655d).f0(i5, (Z4) list.get(i6));
        }
    }

    public static void f(int i5, List list, C0303n c0303n, boolean z4) {
        if (list == null || list.isEmpty()) {
            return;
        }
        f5 f5Var = (f5) c0303n.f5655d;
    ...
    public static void g(int i5, List list, C0303n c0303n, boolean z4) {
        if (list == null || list.isEmpty()) {
            return;
        }
        f5 f5Var = (f5) c0303n.f5655d;
    ...
    public static void h(int i5, List list, C0303n c0303n, boolean z4) {
        if (list == null || list.isEmpty()) {
            return;
        }
        f5 f5Var = (f5) c0303n.f5655d;
    ...
    public static void i(int i5, List list, C0303n c0303n, boolean z4) {
        if (list == null || list.isEmpty()) {
            return;
        }
        f5 f5Var = (f5) c0303n.f5655d;
    ...
    public static void j(int i5, List list, C0303n c0303n, boolean z4) {
        if (list == null || list.isEmpty()) {
            return;
        }
        f5 f5Var = (f5) c0303n.f5655d;
    ...
    public static void k(int i5, List list, C0303n c0303n, A a3) {
        if (list == null || list.isEmpty()) {
            return;
        }
        for (int i6 = 0; i6 < list.size(); i6++) {
            c0303n.C(i5, a3, list.get(i6));
        }
    }

    public static void l(int i5, List list, C0303n c0303n, boolean z4) {
        if (list == null || list.isEmpty()) {
            return;
        }
        f5 f5Var = (f5) c0303n.f5655d;
    ...
    public static void m(int i5, List list, C0303n c0303n, boolean z4) {
        if (list == null || list.isEmpty()) {
            return;
        }
        f5 f5Var = (f5) c0303n.f5655d;
    ...
    public static void n(int i5, List list, C0303n c0303n, A a3) {
        if (list == null || list.isEmpty()) {
            return;
        }
        for (int i6 = 0; i6 < list.size(); i6++) {
            c0303n.F(i5, a3, list.get(i6));
        }
    }

    public static void o(int i5, List list, C0303n c0303n, boolean z4) {
        if (list == null || list.isEmpty()) {
            return;
        }
        f5 f5Var = (f5) c0303n.f5655d;
    ...
    public static void p(int i5, List list, C0303n c0303n, boolean z4) {
        if (list == null || list.isEmpty()) {
            return;
        }
        f5 f5Var = (f5) c0303n.f5655d;
    ...
    public static void q(int i5, List list, C0303n c0303n, boolean z4) {
        if (list == null || list.isEmpty()) {
            return;
        }
        f5 f5Var = (f5) c0303n.f5655d;
    ...
    public static void r(int i5, List list, C0303n c0303n, boolean z4) {
        if (list == null || list.isEmpty()) {
            return;
        }
        f5 f5Var = (f5) c0303n.f5655d;
    ...
    public static void s(int i5, List list, C0303n c0303n) {
        if (list == null || list.isEmpty()) {
            return;
        }
        c0303n.getClass();
        boolean z4 = list instanceof InterfaceC0273i;
        int i6 = 0;
        f5 f5Var = (f5) c0303n.f5655d;
        if (!z4) {
            while (i6 < list.size()) {
    ...
    public static void t(int i5, List list, C0303n c0303n, boolean z4) {
        if (list == null || list.isEmpty()) {
            return;
        }
        f5 f5Var = (f5) c0303n.f5655d;
    ...
    public static void v(int i5, List list, C0303n c0303n, boolean z4) {
        if (list == null || list.isEmpty()) {
            return;
        }
        f5 f5Var = (f5) c0303n.f5655d;
