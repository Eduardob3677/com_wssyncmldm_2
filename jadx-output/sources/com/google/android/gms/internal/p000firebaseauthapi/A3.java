...
public final class A3 extends AbstractC0242c4 {
    public final /* synthetic */ int n;

    /* renamed from: o, reason: collision with root package name */
    public final C0235b3 f5326o;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public A3(c cVar, String str, int i5) {
        super(2);
        this.n = i5;
        switch (i5) {
            case 1:
                super(2);
                AbstractC0213D.f("credential cannot be null", cVar);
                this.f5326o = new C0235b3(b.Q(cVar, str));
                break;
            default:
                AbstractC0213D.f("credential cannot be null", cVar);
                N4 n4Q = b.Q(cVar, str);
                n4Q.f5444l = false;
                this.f5326o = new C0235b3(n4Q);
                break;
        }
    }
    ...
    public final C0091m a() {
        switch (this.n) {
            case 0:
                ...
                c0091mC.f2404b = new C0303n(17, this);
                return c0091mC.b();
            default:
                C0091m c0091mC2 = C0091m.c();
                c0091mC2.f2404b = new C0303n(21, this);
                return c0091mC2.b();
        }
    }
