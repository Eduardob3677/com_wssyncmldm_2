...
public final class D3 extends AbstractC0242c4 {
    public final /* synthetic */ int n;

    /* renamed from: o, reason: collision with root package name */
    public final C0259f3 f5355o;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public D3(j jVar, String str, int i5) {
        super(2);
        this.n = i5;
        switch (i5) {
            case 1:
                ...
                this.f5355o = new C0259f3(jVar, str);
                break;
            default:
                AbstractC0213D.f("credential cannot be null", jVar);
                jVar.f2937g = false;
                this.f5355o = new C0259f3(jVar, str);
                break;
        }
    ...
    public final C0091m a() {
        switch (this.n) {
            case 0:
                ...
                c0091mC.f2404b = new C0303n(20, this);
                return c0091mC.b();
            default:
                C0091m c0091mC2 = C0091m.c();
                c0091mC2.f2404b = new C0303n(24, this);
                return c0091mC2.b();
        }
    }
