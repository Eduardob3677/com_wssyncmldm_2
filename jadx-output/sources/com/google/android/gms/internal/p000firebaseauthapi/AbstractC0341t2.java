...
public abstract class AbstractC0341t2 implements InterfaceC0371y2 {

    /* renamed from: c, reason: collision with root package name */
    public static final int[] f5730c = h(new byte[]{101, 120, 112, 97, 110, 100, 32, 51, 50, 45, 98, 121, 116, 101, 32, 107});
    ...
    public AbstractC0341t2(byte[] bArr, int i5) throws InvalidKeyException {
        if (bArr.length != 32) {
    ...
    public final byte[] g(ByteBuffer byteBuffer) throws GeneralSecurityException {
        ...
        for (int i7 = 0; i7 < i6; i7++) {
            ByteBuffer byteBufferD = d(this.f5732b + i7, bArr);
            if (i7 == i5) {
                AbstractC0332s.m(byteBufferAllocate, byteBuffer, byteBufferD, iRemaining % 64);
            } else {
                AbstractC0332s.m(byteBufferAllocate, byteBuffer, byteBufferD, 64);
            }
        }
