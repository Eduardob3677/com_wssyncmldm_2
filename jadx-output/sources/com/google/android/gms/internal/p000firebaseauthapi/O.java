...
public abstract class O {
    ...
    public static final M f5450a;

    static {
        if (L.f5416e && L.f5415d) {
            int i5 = W4.f5485a;
        }
        f5450a = new M(0);
    }
        ...
        while (i10 < length) {
            ...
            if (cCharAt2 < 128 && i11 < i9) {
                ...
                if ((cCharAt2 >= 55296 && cCharAt2 <= 57343) || i11 > i9 - 3) {
                    if (i11 > i9 - 4) {
                        if (cCharAt2 >= 55296 && cCharAt2 <= 57343 && ((i7 = i10 + 1) == charSequence.length() || !Character.isSurrogatePair(cCharAt2, charSequence.charAt(i7)))) {
    ...
    public static String d(byte[] bArr, int i5, int i6) throws C0255f {
        ...
        while (i5 < i7) {
            ...
            if (b5 >= 0) {
                ...
                if (b5 >= -32) {
                    ...
                    byte b10 = bArr[i12];
                    byte b11 = bArr[i13];
                    if (!AbstractC0332s.L(b9)) {
                        if ((((b9 + 112) + (b5 << 28)) >> 30) == 0 && !AbstractC0332s.L(b10) && !AbstractC0332s.L(b11)) {
