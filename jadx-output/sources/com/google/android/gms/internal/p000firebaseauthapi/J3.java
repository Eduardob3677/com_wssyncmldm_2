...
public abstract class J3 {
    ...
    public static final SparseArray f5398a;
    ...
    */
    public static h a(Status status) {
        ...
        Pair pair = (Pair) f5398a.get(i5);
        String strC = c(pair != null ? (String) pair.second : "An internal error has occurred.", status);
        if (i5 == 17020) {
            return new i(c("A network error (such as timeout, interrupted connection or unreachable host) has occurred.", status));
        }
        if (i5 != 17021) {
            if (i5 != 17051) {
                if (i5 == 17052) {
                ...
                if (i5 != 17057 && i5 != 17058) {
                    if (i5 != 17000 && i5 != 17002 && i5 != 17049) {
                        if (i5 != 17068) {
                            if (i5 != 17077) {
                                if (i5 == 17495) {
                                    return new b(c("Please sign in before trying to get a token.", status));
                                }
                                if (i5 == 17499) {
                                    return new h(c("An internal error has occurred.", status));
                                }
                                if (i5 != 18001 && i5 != 17093) {
                                    if (i5 != 17094) {
                                        switch (i5) {
                                            case 17004:
                                            case 17008:
                                            ...
                                            case 17007:
                                            case 17012:
                                                return new f(b(i5), strC);
                                            case 17010:
                                                return new b(c("We have blocked all requests from this device due to unusual activity. Try again later.", status));
                                            default:
                                                switch (i5) {
                                                    case 17079:
                                                    case 17085:
                                                    ...
                                                    default:
                                                        switch (i5) {
                                                            case 17014:
                                                                return new f(b(i5), strC);
                                                            case 17015:
                                                                return new h(c("User has already been linked to the given provider.", status));
                                                            case 17016:
                                                                return new h(c("User was not linked to an account with the given provider.", status));
                                                            case 17017:
                                                                break;
                                                            default:
                                                                switch (i5) {
                                                                            ...
                                                                            default:
                                                                                switch (i5) {
                                                                                    ...
                                                                                    default:
                                                                                        switch (i5) {
                                                                                            case 17061:
                                                                                                return new i(c("There was a failure in the connection between the web widget and the Firebase Auth backend.", status));
                                                                                            case 17062:
                                                                                            case 17065:
                                                                                                break;
                                                                                            case 17063:
    ...
    public static String c(String str, Status status) {
        return TextUtils.isEmpty(status.f5310e) ? str : String.format(String.valueOf(str).concat(" [ %s ]"), status.f5310e);
    }
}
