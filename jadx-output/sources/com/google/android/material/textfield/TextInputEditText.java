...
public class TextInputEditText extends C0626u {

    /* renamed from: g, reason: collision with root package name */
    public final Rect f6079g;
    ...
    public TextInputEditText(Context context, AttributeSet attributeSet) {
        ...
        this.f6079g = new Rect();
        int[] iArr = v1.a.f9524A;
    ...
    public final void getFocusedRect(Rect rect) {
        ...
        TextInputLayout textInputLayout = getTextInputLayout();
        if (textInputLayout == null || !this.f6080h || rect == null) {
            return;
        }
        Rect rect2 = this.f6079g;
    ...
    public final boolean getGlobalVisibleRect(Rect rect, Point point) {
        TextInputLayout textInputLayout = getTextInputLayout();
        if (textInputLayout == null || !this.f6080h) {
    ...
    public CharSequence getHint() {
        TextInputLayout textInputLayout = getTextInputLayout();
        return (textInputLayout == null || !textInputLayout.f6091G) ? super.getHint() : textInputLayout.getHint();
    }
    ...
    public final void onAttachedToWindow() {
        ...
        TextInputLayout textInputLayout = getTextInputLayout();
        if (textInputLayout != null && textInputLayout.f6091G && super.getHint() == null) {
    ...
    @Override // k.C0626u, android.widget.TextView, android.view.View
