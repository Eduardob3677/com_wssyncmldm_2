...
public abstract class BasicViewPagerAppBarWhiteCaseView extends BasicViewPagerAppBarView {
    ...
    private final int getViewPagerIndicatorOffWithWhiteCaseColor(Context context) {
        i.e("context", context);
        return AbstractC0934b.a(context, TextUtils.isEmpty(Settings.System.getString(context.getContentResolver(), "current_sec_active_themepackage")) ? a.S(context) ? R.color.sesl_appbar_viewpager_indicator_off_with_white_case : R.color.sesl_appbar_viewpager_indicator_off_dark : a.S(context) ? R.color.sesl_appbar_viewpager_indicator_off_with_white_case_for_theme : R.color.sesl_appbar_viewpager_indicator_off_dark_for_theme);
    }
    ...
    public /* synthetic */ BasicViewPagerAppBarWhiteCaseView(Context context, AttributeSet attributeSet, int i5, AbstractC0393e abstractC0393e) {
