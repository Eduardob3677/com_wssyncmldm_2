...
import k.J1;
import k.ViewOnClickListenerC0577b1;
...
public class SuggestAppBarView extends AbstractC0928a {
    ...
    private final Button generateButton(ButtonModel buttonModel, int style) {
        ...
        button.setText(buttonModel.f5818a);
        String str = buttonModel.f5820c;
        if (str != null) {
            button.setContentDescription(str);
        }
        button.setOnClickListener(new ViewOnClickListenerC0577b1(buttonModel, this, 1));
        return button;
    }
    ...
    public static final void generateButton$lambda$9$lambda$8(ButtonModel buttonModel, SuggestAppBarView suggestAppBarView, View view) {
        ...
        i.e("this$0", suggestAppBarView);
        AppBarModel.OnClickListener onClickListener = buttonModel.f5819b;
    ...
    public void inflate() throws Resources.NotFoundException {
        ...
        if (imageButton2 != null) {
            AbstractC0739a.p(o4.a.m(), imageButton2);
    ...
    public final void setButtonModules(ButtonListModel buttonModels) {
        i.e("buttonModels", buttonModels);
        ViewGroup viewGroup = this.bottomLayout;
        if (viewGroup != null) {
            viewGroup.removeAllViews();
        }
        this.buttons.clear();
        List list = buttonModels.f5817b;
        int i5 = 0;
        for (Object obj : list) {
            int i6 = i5 + 1;
            if (i5 < 0) {
            ...
            boolean zS = a.S(getContext());
            ButtonStyle buttonStyle = buttonModels.f5816a;
            Button buttonGenerateButton = generateButton(buttonModel, zS ? buttonStyle.f5821a : buttonStyle.f5822b);
    ...
    public final void setCloseClickListener(AppBarModel.OnClickListener closeClickListener) {
        ...
        if (imageButton != null) {
            ...
            imageButton.setOnClickListener(new ViewOnClickListenerC0577b1(closeClickListener, this, 2));
        }
    }
    ...
    public void updateResource(Context context) throws Resources.NotFoundException {
        ...
        if (imageButton != null) {
            ...
            i.d("resources.getString(andr…l_appbar_suggest_dismiss)", string);
    ...
    public /* synthetic */ SuggestAppBarView(Context context, AttributeSet attributeSet, int i5, AbstractC0393e abstractC0393e) {
