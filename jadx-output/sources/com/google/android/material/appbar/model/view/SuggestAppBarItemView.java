...
public class SuggestAppBarItemView extends SuggestAppBarView {
    ...
    private final void updateButton(Button button) {
        ...
        a.k(button, R.dimen.sesl_appbar_button_text_size, 2);
    }
    ...
    public void updateResource(Context context) throws Resources.NotFoundException {
        ...
        boolean zS = a.S(context);
        ViewGroup viewGroup = this.rootView;
        if (viewGroup != null) {
            viewGroup.setBackgroundTintList(ColorStateList.valueOf(AbstractC0934b.a(context, zS ? R.color.sesl_viewpager_item_background : R.color.sesl_viewpager_item_background_dark)));
        }
        TextView titleView = getTitleView();
        if (titleView != null) {
            a.k(titleView, R.dimen.sesl_appbar_suggest_title_text_size, 1);
        }
        updateButtons(getButtons());
    }

    public /* synthetic */ SuggestAppBarItemView(Context context, AttributeSet attributeSet, int i5, AbstractC0393e abstractC0393e) {
