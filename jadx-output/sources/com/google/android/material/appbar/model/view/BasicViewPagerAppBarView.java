...
public abstract class BasicViewPagerAppBarView extends ViewPagerAppBarView {
    ...
    private final C0929b pageChangeCallback;
    ...
    public final void moveNextAndRemove(ViewPager2 viewPager, int index) {
        AbstractC0526A adapter = viewPager.getAdapter();
    ...
    public final void addIndicator() throws Resources.NotFoundException {
        C0589f1 indicator = getIndicator();
        if (indicator != null) {
            Context context = indicator.getContext();
            i.d("context", context);
            C0583d1 c0583d1 = new C0583d1(context);
            c0583d1.f7845c = indicator.f7853e;
            c0583d1.a(c0583d1.f7847e);
            c0583d1.f7846d = indicator.f;
            c0583d1.a(c0583d1.f7847e);
            c0583d1.setOnClickListener(new d(6, indicator));
            indicator.f7851c.add(c0583d1);
            c0583d1.setAccessibilityDelegate(new C0586e1(indicator, c0583d1));
            ...
            indicator.addView(c0583d1, layoutParams);
            if (indicator.f7854g == -1) {
    ...
    public final void initIndicator(int count) throws Resources.NotFoundException {
        ...
        if (viewpager != null) {
            ((ArrayList) viewpager.f5031e.f848b).add(this.pageChangeCallback);
        }
    }
    ...
    public final void removeItem(int index, boolean animate) {
        ...
        if (recyclerView == null || (b0VarQ = recyclerView.Q(index)) == null || (view = b0VarQ.f7406a) == null) {
            internalRemoveItem(index);
            return;
        }
        if (this.deleteAnimator == null) {
            ...
            if (valueAnimator == null) {
                i.g("deleteScaleAnimator");
                throw null;
            }
            animatorSet.playTogether(n.y0(valueAnimator, this.deleteAlphaAnimator));
            this.deleteAnimator = animatorSet;
        }
        ValueAnimator valueAnimator2 = this.deleteAlphaAnimator;
        valueAnimator2.removeAllListeners();
        valueAnimator2.addListener(new C0930c(this, viewpager, index));
    ...
    public /* synthetic */ BasicViewPagerAppBarView(Context context, AttributeSet attributeSet, int i5, AbstractC0393e abstractC0393e) {
    ...
    public BasicViewPagerAppBarView(Context context, AttributeSet attributeSet) {
        ...
        this.pageChangeCallback = new C0929b(this);
    }
}
