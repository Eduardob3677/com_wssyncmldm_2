...
public final class e {
    ...
    public final Set f9595d;

    public e(String str, HashMap map, HashSet hashSet, HashSet hashSet2) {
        this.f9592a = str;
        this.f9593b = Collections.unmodifiableMap(map);
        this.f9594c = Collections.unmodifiableSet(hashSet);
        this.f9595d = hashSet2 == null ? null : Collections.unmodifiableSet(hashSet2);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        e eVar = (e) obj;
        String str = eVar.f9592a;
        String str2 = this.f9592a;
        if (str2 == null ? str != null : !str2.equals(str)) {
            return false;
        }
        Map map = eVar.f9593b;
        Map map2 = this.f9593b;
        if (map2 == null ? map != null : !map2.equals(map)) {
            return false;
        }
        Set set2 = eVar.f9594c;
        Set set3 = this.f9594c;
        if (set3 == null ? set2 != null : !set3.equals(set2)) {
            return false;
        }
        Set set4 = this.f9595d;
        if (set4 == null || (set = eVar.f9595d) == null) {
            return true;
        }
    ...
    public final String toString() {
        return "TableInfo{name='" + this.f9592a + "', columns=" + this.f9593b + ", foreignKeys=" + this.f9594c + ", indices=" + this.f9595d + '}';
    }
}
