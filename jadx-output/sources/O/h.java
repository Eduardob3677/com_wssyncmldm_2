...
public final class h implements Runnable {
    ...
    public final /* synthetic */ NestedScrollView f1935d;

    public /* synthetic */ h(NestedScrollView nestedScrollView, int i5) {
        this.f1934c = i5;
        this.f1935d = nestedScrollView;
    }

    @Override // java.lang.Runnable
    public final void run() {
        boolean z4 = false;
        NestedScrollView nestedScrollView = this.f1935d;
        switch (this.f1934c) {
            case 0:
                float f = NestedScrollView.f3612h0;
                nestedScrollView.getClass();
                if (nestedScrollView.f3622I) {
                    ...
                    nestedScrollView.f3621H = z4;
                    nestedScrollView.E = z4;
                    return;
                }
                return;
            case 1:
                float f5 = NestedScrollView.f3612h0;
                nestedScrollView.getClass();
                throw null;
            case 2:
                float f6 = NestedScrollView.f3612h0;
                nestedScrollView.getClass();
                throw null;
            case 3:
