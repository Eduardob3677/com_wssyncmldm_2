...
public abstract class g {
    ...
    public static final DataBinderMapperImpl f3671a = new DataBinderMapperImpl();
    ...
    public static v a(View view) {
        ...
        DataBinderMapperImpl dataBinderMapperImpl = f3671a;
    ...
    public static v c(LayoutInflater layoutInflater, int i5, ViewGroup viewGroup, boolean z4) {
        ...
        return z5 ? b(viewGroup, z5 ? viewGroup.getChildCount() : 0, i5) : f3671a.getDataBinder((f) null, layoutInflater.inflate(i5, viewGroup, z4), i5);
    }

    public static v d(Activity activity, int i5) {
        activity.setContentView(i5);
        return b((ViewGroup) activity.getWindow().getDecorView().findViewById(R.id.content), 0, i5);
    }
}
