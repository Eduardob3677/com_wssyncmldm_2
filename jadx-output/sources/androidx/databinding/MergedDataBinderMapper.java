...
public class MergedDataBinderMapper extends e {
    ...
    public final HashSet f3663a = new HashSet();

    /* renamed from: b, reason: collision with root package name */
    public final CopyOnWriteArrayList f3664b = new CopyOnWriteArrayList();

    /* renamed from: c, reason: collision with root package name */
    public final CopyOnWriteArrayList f3665c = new CopyOnWriteArrayList();

    public final void a(e eVar) {
        if (this.f3663a.add(eVar.getClass())) {
    ...
    public final boolean b() throws ClassNotFoundException {
        CopyOnWriteArrayList copyOnWriteArrayList = this.f3665c;
