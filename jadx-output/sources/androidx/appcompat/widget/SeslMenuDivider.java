...
public class SeslMenuDivider extends ImageView {
    ...
    public final Paint f3418e;

    public SeslMenuDivider(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, 0);
        DisplayMetrics displayMetrics = context.getResources().getDisplayMetrics();
        this.f3417d = (int) TypedValue.applyDimension(1, 1.5f, displayMetrics);
        this.f3416c = (int) TypedValue.applyDimension(1, 3.0f, displayMetrics);
        Paint paint = new Paint();
        this.f3418e = paint;
        paint.setFlags(1);
        Resources resources = context.getResources();
        int i5 = W1.a.S(context) ? R.color.sesl_popup_menu_divider_color_light : R.color.sesl_popup_menu_divider_color_dark;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        for (int i13 = 0; i13 < i10; i13++) {
            canvas.drawCircle(paddingStart + i12, height / 2.0f, i7 / 2.0f, this.f3418e);
