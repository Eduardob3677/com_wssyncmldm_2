...
public final class a extends Drawable {
    ...
    public g[] f3230g = null;

    /* renamed from: h, reason: collision with root package name */
    public final Path f3231h = new Path();
    ...
    public final void draw(Canvas canvas) {
        boolean z4;
        Path path;
        if (this.f3229e == canvas.getWidth() && this.f == canvas.getHeight()) {
            z4 = false;
        } else {
            this.f3229e = canvas.getWidth();
            this.f = canvas.getHeight();
            z4 = true;
        }
        ColorFilter colorFilter = this.f3228d;
        ...
        if (i5 <= 0 || i6 <= 0) {
            ...
            matrix2.setRotate(this.f3227c, bounds.width() / 2.0f, bounds.height() / 2.0f);
    ...
    public final void setAlpha(int i5) {
        this.f3225a.setAlpha(i5);
    }

    @Override // android.graphics.drawable.Drawable
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f3228d = colorFilter;
    }
}
