...
public class b {
    ...
    public b(Context context) throws Resources.NotFoundException {
        ...
        if (i7 <= 0 || (i6 = typedValue.type) < 28 || i6 > 31) {
            ...
            if (color <= 0 || (i5 = typedValue.type) < 28 || i5 > 31) {
                color = resources.getColor(z4 ? R.color.sesl_round_and_bgcolor_dark : R.color.sesl_round_and_bgcolor_light);
            }
        } else {
    ...
    public final void a(Canvas canvas) {
        ...
        int i6 = i5 + (cVar != null ? cVar.f182a : 0);
        int i7 = rect.right - (cVar != null ? cVar.f184c : 0);
        int i8 = rect.top + (cVar != null ? cVar.f183b : 0);
        int i9 = rect.bottom - (cVar != null ? cVar.f185d : 0);
        ...
        if (i14 == this.mTopRightRoundColor && i14 == this.mBottomLeftRoundColor && i14 == this.mBottomRightRoundColor) {
            ...
            if (cVar2 != null && cVar2.f183b > 0) {
                B.c cVar3 = this.mInsets;
                canvas.drawRect(new Rect(i6 - cVar3.f182a, i8 - cVar3.f183b, cVar3.f184c + i7, i8), paint);
            }
            B.c cVar4 = this.mInsets;
            if (cVar4 != null && cVar4.f185d > 0) {
                B.c cVar5 = this.mInsets;
                canvas.drawRect(new Rect(i6 - cVar5.f182a, i9, cVar5.f184c + i7, cVar5.f185d + i9), paint);
            }
            B.c cVar6 = this.mInsets;
            if (cVar6 != null && cVar6.f182a > 0) {
                B.c cVar7 = this.mInsets;
                canvas.drawRect(new Rect(i6 - cVar7.f182a, i8 - cVar7.f183b, i6, cVar7.f185d + i9), paint);
            }
            B.c cVar8 = this.mInsets;
            if (cVar8 == null || cVar8.f184c <= 0) {
                return;
            }
            B.c cVar9 = this.mInsets;
            canvas.drawRect(new Rect(i7, i8 - cVar9.f183b, cVar9.f184c + i7, i9 + cVar9.f185d), paint);
        }
    }
    ...
    public void setRoundedCornerColor(int i5, int i6) {
        ...
        if ((i5 & (-16)) != 0) {
            throw new IllegalArgumentException(f.t(i5, "Use wrong rounded corners to the param, corners = "));
        }
        ...
        if ((i5 & 1) != 0) {
            ...
            this.mTopLeftRound.f3228d = porterDuffColorFilter;
        }
        if ((i5 & 2) != 0) {
            this.mTopRightRoundColor = i6;
            this.mTopRightRound.f3228d = porterDuffColorFilter;
        }
        if ((i5 & 4) != 0) {
            this.mBottomLeftRoundColor = i6;
            this.mBottomLeftRound.f3228d = porterDuffColorFilter;
        }
        if ((i5 & 8) != 0) {
            this.mBottomRightRoundColor = i6;
            this.mBottomRightRound.f3228d = porterDuffColorFilter;
        }
    }
