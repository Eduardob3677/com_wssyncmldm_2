...
public final class p0 extends r0 {
    public static boolean s(Transition transition) {
        return (r0.h(transition.getTargetIds()) && r0.h(transition.getTargetNames()) && r0.h(transition.getTargetTypes())) ? false : true;
    }
    ...
    public final void b(Object obj, ArrayList arrayList) {
        ...
        if (s(transition) || !r0.h(transition.getTargets())) {
            return;
        }
    ...
    public final void k(Object obj, View view, ArrayList arrayList) {
        ((Transition) obj).addListener(new m0(view, arrayList));
    }

    @Override // androidx.fragment.app.r0
    public final void l(Object obj, Object obj2, ArrayList arrayList, Object obj3, ArrayList arrayList2) {
        ((Transition) obj).addListener(new n0(this, obj2, arrayList, obj3, arrayList2));
    }
    ...
    public final void m(View view, Object obj) {
        if (view != null) {
            Rect rect = new Rect();
            r0.g(rect, view);
            ((Transition) obj).setEpicenterCallback(new l0(0, rect));
        }
    }

    @Override // androidx.fragment.app.r0
    public final void n(Object obj, Rect rect) {
        ((Transition) obj).setEpicenterCallback(new l0(1, rect));
    }

    @Override // androidx.fragment.app.r0
    public final void o(Object obj, F.f fVar, t0 t0Var) {
        ((Transition) obj).addListener(new o0(t0Var));
    }
    ...
    public final void p(Object obj, View view, ArrayList arrayList) {
        ...
        for (int i5 = 0; i5 < size; i5++) {
            r0.d((View) arrayList.get(i5), targets);
        }
        targets.add(view);
        arrayList.add(view);
