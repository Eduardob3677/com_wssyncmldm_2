...
public class r extends Fragment implements DialogInterface.OnCancelListener, DialogInterface.OnDismissListener {
    ...
    private Runnable mDismissRunnable = new RunnableC0121m(0, this);
    private DialogInterface.OnCancelListener mOnCancelListener = new DialogInterfaceOnCancelListenerC0122n(this);
    private DialogInterface.OnDismissListener mOnDismissListener = new DialogInterfaceOnDismissListenerC0123o(this);
    private int mStyle = 0;
    private int mTheme = 0;
    private boolean mCancelable = true;
    private boolean mShowsDialog = true;
    private int mBackStackId = -1;
    private androidx.lifecycle.G mObserver = new C0124p(this);
    private boolean mDialogCreated = false;

    @Override // androidx.fragment.app.Fragment
    public J createFragmentContainer() {
        return new C0125q(this, super.createFragmentContainer());
    }
    ...
    public final void f(boolean z4, boolean z5, boolean z6) {
        ...
        if (this.mBackStackId >= 0) {
            if (z6) {
                ...
                if (i5 < 0) {
                    ...
                    throw new IllegalArgumentException(B.f.t(i5, "Bad id: "));
                }
                ...
                if (i6 < 0) {
                    throw new IllegalArgumentException(B.f.t(i6, "Bad id: "));
                }
                parentFragmentManager2.v(new Y(parentFragmentManager2, i6), z4);
            }
            this.mBackStackId = -1;
            return;
        }
        ...
        C0109a c0109a = new C0109a(parentFragmentManager3);
        c0109a.f3905p = true;
        c0109a.g(this);
        if (z6) {
            if (c0109a.f3897g) {
    ...
    public void onStart() {
        ...
        if (dialog != null) {
            ...
            AbstractC0739a.r(decorView, this);
        }
    }
    ...
    public void show(Z z4, String str) {
        this.mDismissed = false;
        this.mShownByMe = true;
        z4.getClass();
        C0109a c0109a = new C0109a(z4);
        c0109a.f3905p = true;
        c0109a.c(0, this, str, 1);
        c0109a.e(false);
    }

    public void showNow(Z z4, String str) {
        this.mDismissed = false;
        this.mShownByMe = true;
        z4.getClass();
        C0109a c0109a = new C0109a(z4);
    ...
    public int show(j0 j0Var, String str) {
        this.mDismissed = false;
        this.mShownByMe = true;
        j0Var.c(0, this, str, 1);
        this.mViewDestroyed = false;
        int iE = ((C0109a) j0Var).e(false);
