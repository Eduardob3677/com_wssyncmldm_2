...
public class SeslRingtonePreference extends Preference {
    public SeslRingtonePreference(Context context, AttributeSet attributeSet) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, I.f4610j, R.attr.ringtonePreferenceStyle, 0);
        typedArrayObtainStyledAttributes.getInt(0, 1);
        typedArrayObtainStyledAttributes.getBoolean(1, true);
        typedArrayObtainStyledAttributes.getBoolean(2, true);
        this.f4658o = new Intent("android.intent.action.RINGTONE_PICKER");
        Method methodJ = i3.x.J(UserHandle.class, "hidden_myUserId", new Class[0]);
        if (methodJ != null) {
            Object objJ0 = i3.x.j0(null, methodJ, new Object[0]);
            if (objJ0 instanceof Integer) {
                ((Integer) objJ0).getClass();
            }
        }
