...
public final class m extends k {
    ...
    public static final WeakReference f3019e = new WeakReference(null);

    /* renamed from: c, reason: collision with root package name */
    public WeakReference f3020c;
    ...
    public final byte[] q() {
        ...
        synchronized (this) {
            try {
                bArrY = (byte[]) this.f3020c.get();
                if (bArrY == null) {
                    bArrY = y();
                    this.f3020c = new WeakReference(bArrY);
                }
            } catch (Throwable th) {
                throw th;
            }
