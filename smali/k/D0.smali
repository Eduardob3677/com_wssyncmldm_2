...
.method public static declared-synchronized a()Lk/D0;
    .locals 2

    const-class v0, Lk/D0;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lk/D0;->e:Lk/D0;

    if-nez v1, :cond_0

    new-instance v1, Lk/D0;

    invoke-direct {v1}, Lk/D0;-><init>()V

    sput-object v1, Lk/D0;->e:Lk/D0;
...
.method public final declared-synchronized b(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    :try_start_1
    invoke-virtual {v0, p2, p3, v1}, Lo/e;->d(JLjava/lang/Long;)Ljava/lang/Object;
    ...
    iget-object p2, v0, Lo/e;->e:[Ljava/lang/Object;

    aget-object p3, p2, p1

    sget-object v2, Lo/e;->g:Ljava/lang/Object;
...
.method public final declared-synchronized d(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p1, v0}, Lk/D0;->c(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    if-eqz v0, :cond_8

    instance-of v2, v0, LD0/p;
    ...
    :cond_1
    :goto_0
    iget-object v0, p0, Lk/D0;->b:Landroid/util/TypedValue;
    ...
    iput-object v0, p0, Lk/D0;->b:Landroid/util/TypedValue;
    ...
    invoke-virtual {p0, p1, v0, v1}, Lk/D0;->b(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
