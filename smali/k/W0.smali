...
.method public constructor <init>(Lk/X0;ILandroid/content/res/ColorStateList;Z)V
    ...
    iput-object v1, p0, Lk/W0;->a:Landroid/graphics/Paint;

    new-instance v3, Landroid/graphics/Paint;

    invoke-direct {v3, v2}, Landroid/graphics/Paint;-><init>(I)V

    iput-object v3, p0, Lk/W0;->b:Landroid/graphics/Paint;
    ...
    iput-object p3, p0, Lk/W0;->f:Landroid/animation/ValueAnimator;

    const-wide/16 v5, 0x64

    invoke-virtual {p3, v5, v6}, Landroid/animation/ValueAnimator;->setDuration(J)Landroid/animation/ValueAnimator;

    iget-object p3, p0, Lk/W0;->f:Landroid/animation/ValueAnimator;
    ...
    new-instance p4, Lk/V0;

    invoke-direct {p4, p0, v4}, Lk/V0;-><init>(Lk/W0;I)V
    ...
    iput-object p1, p0, Lk/W0;->g:Landroid/animation/ValueAnimator;

    const-wide/16 p2, 0x12c

    invoke-virtual {p1, p2, p3}, Landroid/animation/ValueAnimator;->setDuration(J)Landroid/animation/ValueAnimator;

    iget-object p1, p0, Lk/W0;->g:Landroid/animation/ValueAnimator;
    ...
    new-instance p2, Lk/V0;

    invoke-direct {p2, p0, v2}, Lk/V0;-><init>(Lk/W0;I)V
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v6, p0, Lk/W0;->m:Lk/X0;

    if-nez v3, :cond_0

    iget v3, v6, Lk/X0;->B0:I
    ...
    iget p0, p0, Lk/W0;->e:I

    sub-int/2addr p0, v4

    int-to-float p0, p0

    invoke-virtual {p1, v3, v6, p0, v2}, Landroid/graphics/Canvas;->drawCircle(FFFLandroid/graphics/Paint;)V
    ...
    invoke-virtual {p1, v3, v5, p0, v2}, Landroid/graphics/Canvas;->drawCircle(FFFLandroid/graphics/Paint;)V
...
.method public final getOpacity()I
    ...
    iget-object p0, p0, Lk/W0;->a:Landroid/graphics/Paint;
...
.method public final onStateChange([I)Z
    ...
    iget-object v1, p0, Lk/W0;->c:Landroid/content/res/ColorStateList;
    ...
    :cond_4
    iget-boolean p1, p0, Lk/W0;->h:Z

    if-eq p1, v2, :cond_a

    if-eqz v2, :cond_7

    iget-object p1, p0, Lk/W0;->f:Landroid/animation/ValueAnimator;
