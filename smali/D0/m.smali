...
.method static constructor <clinit>()V
    ...
    sput-object v0, LD0/m;->p:Landroid/graphics/Matrix;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, LD0/m;->c:Landroid/graphics/Matrix;

    const/4 v0, 0x0

    iput v0, p0, LD0/m;->h:F

    iput v0, p0, LD0/m;->i:F

    iput v0, p0, LD0/m;->j:F

    iput v0, p0, LD0/m;->k:F

    const/16 v0, 0xff

    iput v0, p0, LD0/m;->l:I

    const/4 v0, 0x0

    iput-object v0, p0, LD0/m;->m:Ljava/lang/String;

    iput-object v0, p0, LD0/m;->n:Ljava/lang/Boolean;

    new-instance v0, Lo/b;

    invoke-direct {v0}, Lo/k;-><init>()V

    iput-object v0, p0, LD0/m;->o:Lo/b;

    new-instance v0, LD0/j;

    invoke-direct {v0}, LD0/j;-><init>()V

    iput-object v0, p0, LD0/m;->g:LD0/j;

    new-instance v0, Landroid/graphics/Path;

    invoke-direct {v0}, Landroid/graphics/Path;-><init>()V

    iput-object v0, p0, LD0/m;->a:Landroid/graphics/Path;

    new-instance v0, Landroid/graphics/Path;

    invoke-direct {v0}, Landroid/graphics/Path;-><init>()V

    iput-object v0, p0, LD0/m;->b:Landroid/graphics/Path;
...
.method public constructor <init>(LD0/m;)V
    ...
    iget-object v2, p1, LD0/m;->g:LD0/j;

    invoke-direct {v1, v2, v0}, LD0/j;-><init>(LD0/j;Lo/b;)V

    iput-object v1, p0, LD0/m;->g:LD0/j;

    new-instance v1, Landroid/graphics/Path;

    iget-object v2, p1, LD0/m;->a:Landroid/graphics/Path;

    invoke-direct {v1, v2}, Landroid/graphics/Path;-><init>(Landroid/graphics/Path;)V

    iput-object v1, p0, LD0/m;->a:Landroid/graphics/Path;

    new-instance v1, Landroid/graphics/Path;

    iget-object v2, p1, LD0/m;->b:Landroid/graphics/Path;

    invoke-direct {v1, v2}, Landroid/graphics/Path;-><init>(Landroid/graphics/Path;)V

    iput-object v1, p0, LD0/m;->b:Landroid/graphics/Path;

    iget v1, p1, LD0/m;->h:F

    iput v1, p0, LD0/m;->h:F

    iget v1, p1, LD0/m;->i:F

    iput v1, p0, LD0/m;->i:F

    iget v1, p1, LD0/m;->j:F

    iput v1, p0, LD0/m;->j:F

    iget v1, p1, LD0/m;->k:F

    iput v1, p0, LD0/m;->k:F

    iget v1, p1, LD0/m;->l:I

    iput v1, p0, LD0/m;->l:I

    iget-object v1, p1, LD0/m;->m:Ljava/lang/String;

    iput-object v1, p0, LD0/m;->m:Ljava/lang/String;
    ...
    :cond_0
    iget-object p1, p1, LD0/m;->n:Ljava/lang/Boolean;

    iput-object p1, p0, LD0/m;->n:Ljava/lang/Boolean;
...
# virtual methods
.method public final a(LD0/j;Landroid/graphics/Matrix;Landroid/graphics/Canvas;II)V
    .locals 18
    ...
    iget-object v0, v7, LD0/j;->a:Landroid/graphics/Matrix;

    move-object/from16 v1, p2

    invoke-virtual {v0, v1}, Landroid/graphics/Matrix;->set(Landroid/graphics/Matrix;)V

    iget-object v10, v7, LD0/j;->a:Landroid/graphics/Matrix;

    iget-object v0, v7, LD0/j;->j:Landroid/graphics/Matrix;
    ...
    :goto_0
    iget-object v0, v7, LD0/j;->b:Ljava/util/ArrayList;
    ...
    invoke-virtual/range {v0 .. v5}, LD0/m;->a(LD0/j;Landroid/graphics/Matrix;Landroid/graphics/Canvas;II)V
    ...
    iget-object v13, v6, LD0/m;->c:Landroid/graphics/Matrix;
    ...
    :cond_2
    iget-object v3, v6, LD0/m;->a:Landroid/graphics/Path;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-virtual {v3}, Landroid/graphics/Path;->reset()V

    iget-object v4, v0, LD0/l;->a:[LB/g;
    ...
    :cond_3
    iget-object v4, v6, LD0/m;->b:Landroid/graphics/Path;

    invoke-virtual {v4}, Landroid/graphics/Path;->reset()V

    instance-of v5, v0, LD0/h;
    ...
    :goto_3
    iget v9, v0, LD0/i;->l:F

    add-float/2addr v5, v9

    rem-float/2addr v5, v10

    iget v14, v0, LD0/i;->k:F

    add-float/2addr v14, v9

    rem-float/2addr v14, v10

    iget-object v9, v6, LD0/m;->f:Landroid/graphics/PathMeasure;
    ...
    iput-object v9, v6, LD0/m;->f:Landroid/graphics/PathMeasure;
    ...
    iget-object v10, v6, LD0/m;->f:Landroid/graphics/PathMeasure;

    const/4 v15, 0x1

    invoke-virtual {v10, v5, v9, v3, v15}, Landroid/graphics/PathMeasure;->getSegment(FFLandroid/graphics/Path;Z)Z

    iget-object v5, v6, LD0/m;->f:Landroid/graphics/PathMeasure;
    ...
    iget-object v3, v0, LD0/i;->g:LA/d;
    ...
    iget-object v5, v6, LD0/m;->e:Landroid/graphics/Paint;
    ...
    iput-object v5, v6, LD0/m;->e:Landroid/graphics/Paint;
    ...
    iget v11, v0, LD0/i;->i:F

    sget-object v16, LD0/p;->l:Landroid/graphics/PorterDuff$Mode;
    ...
    :cond_f
    iget-object v3, v0, LD0/i;->e:LA/d;
    ...
    :goto_9
    iget-object v5, v6, LD0/m;->d:Landroid/graphics/Paint;
    ...
    iput-object v5, v6, LD0/m;->d:Landroid/graphics/Paint;
    ...
    iget-object v11, v0, LD0/i;->n:Landroid/graphics/Paint$Join;
    ...
    :cond_12
    iget-object v11, v0, LD0/i;->m:Landroid/graphics/Paint$Cap;
    ...
    iget v11, v0, LD0/i;->h:F

    sget-object v13, LD0/p;->l:Landroid/graphics/PorterDuff$Mode;
...
.method public setAlpha(F)V
    ...
    invoke-virtual {p0, p1}, LD0/m;->setRootAlpha(I)V
