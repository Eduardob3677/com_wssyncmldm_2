...
# direct methods
.method public static varargs b([F)LF1/s;
    .locals 1
    ...
    iput-object p0, v0, LF1/s;->d:[F

    new-instance p0, Ljava/util/ArrayList;

    invoke-direct {p0}, Ljava/util/ArrayList;-><init>()V

    iput-object p0, v0, LF1/s;->e:Ljava/util/ArrayList;

    new-instance p0, Ljava/util/ArrayList;

    invoke-direct {p0}, Ljava/util/ArrayList;-><init>()V

    iput-object p0, v0, LF1/s;->f:Ljava/util/ArrayList;
...
.method public final a()LF1/s;
    ...
    iget-object v0, p0, LF1/s;->d:[F

    invoke-static {v0}, LF1/s;->b([F)LF1/s;
    ...
    invoke-virtual {v0, v2}, LF1/s;->addUpdateListener(Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V

    goto :goto_0

    :cond_0
    iget-object p0, p0, LF1/s;->f:Ljava/util/ArrayList;
    ...
    invoke-virtual {v0, v1}, LF1/s;->addListener(Landroid/animation/Animator$AnimatorListener;)V
...
.method public final addUpdateListener(Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V
    ...
    iget-object p0, p0, LF1/s;->e:Ljava/util/ArrayList;
...
.method public final bridge synthetic clone()Landroid/animation/Animator;
    ...
    invoke-virtual {p0}, LF1/s;->a()LF1/s;
...
.method public final setTarget(Ljava/lang/Object;)V
    ...
    iput-object v0, p0, LF1/s;->c:Ljava/lang/ref/WeakReference;
