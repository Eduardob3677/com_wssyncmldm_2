...
.method public constructor <init>(I)V
    ...
    iput p1, p0, LC0/j;->z:I

    return-void
.end method

.method public static I(LC0/z;)V
    .locals 3

    iget-object v0, p0, LC0/z;->b:Landroid/view/View;

    invoke-virtual {v0}, Landroid/view/View;->getVisibility()I

    move-result v0

    iget-object v1, p0, LC0/z;->a:Ljava/util/HashMap;
    ...
    iget-object p0, p0, LC0/z;->b:Landroid/view/View;
...
.method public static K(LC0/z;LC0/z;)LC0/F;
    .locals 8
    ...
    iput-boolean v1, v0, LC0/F;->a:Z

    iput-boolean v1, v0, LC0/F;->b:Z
    ...
    iget-object v6, p0, LC0/z;->a:Ljava/util/HashMap;
    ...
    iput-object v6, v0, LC0/F;->e:Landroid/view/ViewGroup;

    goto :goto_0

    :cond_0
    iput v3, v0, LC0/F;->c:I

    iput-object v2, v0, LC0/F;->e:Landroid/view/ViewGroup;

    :goto_0
    if-eqz p1, :cond_1

    iget-object v6, p1, LC0/z;->a:Ljava/util/HashMap;
    ...
    iput-object v2, v0, LC0/F;->f:Landroid/view/ViewGroup;
    ...
    iget p0, v0, LC0/F;->c:I

    iget p1, v0, LC0/F;->d:I

    if-ne p0, p1, :cond_2

    iget-object v3, v0, LC0/F;->e:Landroid/view/ViewGroup;

    iget-object v4, v0, LC0/F;->f:Landroid/view/ViewGroup;
    ...
    :cond_4
    iget-object p0, v0, LC0/F;->f:Landroid/view/ViewGroup;
    ...
    :cond_5
    iget-object p0, v0, LC0/F;->e:Landroid/view/ViewGroup;
...
.method public final J(Landroid/view/View;FF)Landroid/animation/ObjectAnimator;
    ...
    new-instance p3, LC0/i;

    invoke-direct {p3, p1}, LC0/i;-><init>(Landroid/view/View;)V

    invoke-virtual {p2, p3}, Landroid/animation/Animator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    new-instance p3, LC0/h;

    invoke-direct {p3, v0, p1}, LC0/h;-><init>(ILjava/lang/Object;)V

    invoke-virtual {p0, p3}, LC0/t;->a(LC0/s;)V
...
.method public final e(LC0/z;)V
    ...
    invoke-static {p1}, LC0/j;->I(LC0/z;)V
...
.method public final h(LC0/z;)V
    ...
    iget-object p1, p1, LC0/z;->b:Landroid/view/View;
...
.method public final l(Landroid/view/ViewGroup;LC0/z;LC0/z;)Landroid/animation/Animator;
    .locals 21
    ...
    iget v4, v0, LC0/j;->z:I

    invoke-static/range {p2 .. p3}, LC0/j;->K(LC0/z;LC0/z;)LC0/F;

    move-result-object v5

    iget-boolean v6, v5, LC0/F;->a:Z

    if-eqz v6, :cond_0

    iget-object v6, v5, LC0/F;->e:Landroid/view/ViewGroup;

    if-nez v6, :cond_1

    iget-object v6, v5, LC0/F;->f:Landroid/view/ViewGroup;
    ...
    :cond_2
    iget-object v1, v3, LC0/z;->b:Landroid/view/View;
    ...
    invoke-virtual {v0, v3, v11}, LC0/t;->o(Landroid/view/View;Z)LC0/z;

    move-result-object v4

    invoke-virtual {v0, v3, v11}, LC0/t;->r(Landroid/view/View;Z)LC0/z;

    move-result-object v3

    invoke-static {v4, v3}, LC0/j;->K(LC0/z;LC0/z;)LC0/F;

    move-result-object v3

    iget-boolean v3, v3, LC0/F;->a:Z
    ...
    iget-object v2, v2, LC0/z;->a:Ljava/util/HashMap;
    ...
    :goto_3
    invoke-virtual {v0, v1, v9, v10}, LC0/j;->J(Landroid/view/View;FF)Landroid/animation/ObjectAnimator;
    ...
    iget-object v3, v3, LC0/z;->b:Landroid/view/View;
    ...
    :goto_6
    iget-object v4, v2, LC0/z;->b:Landroid/view/View;
    ...
    invoke-virtual {v0, v15, v12}, LC0/t;->r(Landroid/view/View;Z)LC0/z;

    move-result-object v7

    invoke-virtual {v0, v15, v12}, LC0/t;->o(Landroid/view/View;Z)LC0/z;

    move-result-object v13

    invoke-static {v7, v13}, LC0/j;->K(LC0/z;LC0/z;)LC0/F;

    move-result-object v7

    iget-boolean v7, v7, LC0/F;->a:Z
    ...
    :goto_10
    iget-object v0, v0, LC0/z;->a:Ljava/util/HashMap;
    ...
    :goto_11
    invoke-virtual {v5, v14, v10, v0}, LC0/j;->J(Landroid/view/View;FF)Landroid/animation/ObjectAnimator;
    ...
    invoke-direct {v0, v5, v1, v14, v4}, LC0/D;-><init>(LC0/j;Landroid/view/ViewGroup;Landroid/view/View;Landroid/view/View;)V

    invoke-virtual {v5, v0}, LC0/t;->a(LC0/s;)V
    ...
    :goto_13
    invoke-virtual {v5, v7, v10, v0}, LC0/j;->J(Landroid/view/View;FF)Landroid/animation/ObjectAnimator;
    ...
    invoke-direct {v1, v2, v7}, LC0/E;-><init>(ILandroid/view/View;)V
    ...
    invoke-virtual {v5, v1}, LC0/t;->a(LC0/s;)V
...
.method public final q()[Ljava/lang/String;
    ...
    sget-object p0, LC0/j;->A:[Ljava/lang/String;

    return-object p0
.end method

.method public final s(LC0/z;LC0/z;)Z
    .locals 3
    ...
    iget-object v0, p2, LC0/z;->a:Ljava/util/HashMap;
    ...
    iget-object v2, p1, LC0/z;->a:Ljava/util/HashMap;
    ...
    :cond_1
    invoke-static {p1, p2}, LC0/j;->K(LC0/z;LC0/z;)LC0/F;

    move-result-object p1

    iget-boolean p2, p1, LC0/F;->a:Z

    if-eqz p2, :cond_3

    iget p2, p1, LC0/F;->c:I
