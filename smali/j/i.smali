...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v1, p0, Lj/i;->t:Ljava/util/ArrayList;

    new-instance v1, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v1}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v1, p0, Lj/i;->u:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    invoke-static {p1}, LJ/T;->b(Landroid/view/ViewConfiguration;)Z
...
.method public final a(IIILjava/lang/CharSequence;)Lj/k;
    ...
    invoke-direct/range {v2 .. v9}, Lj/k;-><init>(Lj/i;IIIILjava/lang/CharSequence;I)V
    ...
    invoke-virtual {p0, p3}, Lj/i;->p(Z)V
...
.method public final addIntentOptions(IIILandroid/content/ComponentName;[Landroid/content/Intent;Landroid/content/Intent;I[Landroid/view/MenuItem;)I
    ...
    invoke-virtual {p0, p1, p2, p3, v4}, Lj/i;->a(IIILjava/lang/CharSequence;)Lj/k;
    ...
    invoke-virtual {v4, v5}, Lj/k;->setIcon(Landroid/graphics/drawable/Drawable;)Landroid/view/MenuItem;

    iput-object v3, v4, Lj/k;->g:Landroid/content/Intent;
...
.method public final addSubMenu(IIILjava/lang/CharSequence;)Landroid/view/SubMenu;
    ...
    invoke-direct {p2, p3, p0, p1}, Lj/A;-><init>(Landroid/content/Context;Lj/i;Lj/k;)V

    iput-object p2, p1, Lj/k;->o:Lj/A;

    iget-object p0, p1, Lj/k;->e:Ljava/lang/CharSequence;

    invoke-virtual {p2, p0}, Lj/A;->setHeaderTitle(Ljava/lang/CharSequence;)Landroid/view/SubMenu;
...
.method public final c(Z)V
    ...
    :cond_1
    invoke-interface {v3, p0, p1}, Lj/u;->a(Lj/i;Z)V
...
.method public d(Lj/k;)Z
    ...
    :cond_2
    invoke-interface {v4, p1}, Lj/u;->g(Lj/k;)Z
...
.method public f(Lj/k;)Z
    ...
    :cond_2
    invoke-interface {v4, p1}, Lj/u;->e(Lj/k;)Z
...
.method public final findItem(I)Landroid/view/MenuItem;
    ...
    iget-object p0, p0, Lj/i;->f:Ljava/util/ArrayList;
    ...
    iget-object v2, v2, Lj/k;->o:Lj/A;

    invoke-virtual {v2, p1}, Lj/i;->findItem(I)Landroid/view/MenuItem;
...
.method public final g(ILandroid/view/KeyEvent;)Lj/k;
    ...
    iget-object v0, p0, Lj/i;->t:Ljava/util/ArrayList;
    ...
    iget-char v7, v6, Lj/k;->j:C

    goto :goto_1

    :cond_2
    iget-char v7, v6, Lj/k;->h:C
...
.method public final h(Ljava/util/ArrayList;ILandroid/view/KeyEvent;)V
    ...
    invoke-virtual {v7}, Lj/k;->hasSubMenu()Z

    move-result v8

    if-eqz v8, :cond_1

    iget-object v8, v7, Lj/k;->o:Lj/A;

    invoke-virtual {v8, p1, p2, p3}, Lj/i;->h(Ljava/util/ArrayList;ILandroid/view/KeyEvent;)V

    :cond_1
    if-eqz v0, :cond_2

    iget-char v8, v7, Lj/k;->j:C

    goto :goto_1

    :cond_2
    iget-char v8, v7, Lj/k;->h:C
    ...
    :cond_4
    invoke-virtual {v7}, Lj/k;->isEnabled()Z
...
.method public final hasVisibleItems()Z
    ...
    invoke-virtual {v4}, Lj/k;->isVisible()Z
...
.method public final i()V
    ...
    :cond_0
    iget-object v1, p0, Lj/i;->u:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public final l()Ljava/util/ArrayList;
    ...
    invoke-virtual {v5}, Lj/k;->isVisible()Z
...
.method public final p(Z)V
    ...
    :cond_0
    iget-object p1, p0, Lj/i;->u:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public final performIdentifierAction(II)Z
    ...
    invoke-virtual {p0, p1, v0, p2}, Lj/i;->q(Landroid/view/MenuItem;Lj/u;I)Z
...
.method public final performShortcut(ILandroid/view/KeyEvent;I)Z
    ...
    invoke-virtual {p0, p1, p2, p3}, Lj/i;->q(Landroid/view/MenuItem;Lj/u;I)Z
...
.method public final q(Landroid/view/MenuItem;Lj/u;I)Z
    ...
    :cond_2
    iget-object v3, p1, Lj/k;->g:Landroid/content/Intent;
    ...
    :goto_1
    iget-object v3, p1, Lj/k;->A:Lj/l;

    if-eqz v3, :cond_5

    iget-object v4, v3, Lj/l;->a:Landroid/view/ActionProvider;
    ...
    iget-object v5, p0, Lj/i;->a:Landroid/content/Context;

    invoke-direct {p3, v5, p0, p1}, Lj/A;-><init>(Landroid/content/Context;Lj/i;Lj/k;)V

    iput-object p3, p1, Lj/k;->o:Lj/A;

    iget-object v5, p1, Lj/k;->e:Ljava/lang/CharSequence;

    invoke-virtual {p3, v5}, Lj/A;->setHeaderTitle(Ljava/lang/CharSequence;)Landroid/view/SubMenu;

    :cond_a
    iget-object p1, p1, Lj/k;->o:Lj/A;

    if-eqz v4, :cond_b

    iget-object p3, v3, Lj/l;->b:Lj/p;

    invoke-virtual {p3}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object p3, v3, Lj/l;->a:Landroid/view/ActionProvider;

    invoke-virtual {p3, p1}, Landroid/view/ActionProvider;->onPrepareSubMenu(Landroid/view/SubMenu;)V

    :cond_b
    iget-object p3, p0, Lj/i;->u:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    invoke-interface {p2, p1}, Lj/u;->h(Lj/A;)Z
    ...
    invoke-interface {v4, p1}, Lj/u;->h(Lj/A;)Z
...
.method public final r(Lj/u;)V
    ...
    iget-object p0, p0, Lj/i;->u:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public final s(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v3, p1}, Lj/i;->s(Landroid/os/Bundle;)V
...
.method public final setGroupCheckable(IZZ)V
    ...
    invoke-virtual {v3, p2}, Lj/k;->setCheckable(Z)Landroid/view/MenuItem;
...
.method public final setGroupEnabled(IZ)V
    ...
    invoke-virtual {v2, p2}, Lj/k;->setEnabled(Z)Landroid/view/MenuItem;
...
.method public final setGroupVisible(IZ)V
    ...
    invoke-virtual {p0, v5}, Lj/i;->p(Z)V
...
.method public final t(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v3, p1}, Lj/i;->t(Landroid/os/Bundle;)V
...
.method public final u(ILjava/lang/CharSequence;ILandroid/graphics/drawable/Drawable;Landroid/view/View;)V
    ...
    iput-object p1, p0, Lj/i;->m:Ljava/lang/CharSequence;
    ...
    invoke-static {p1, p3}, Lz/a;->b(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object p1

    iput-object p1, p0, Lj/i;->n:Landroid/graphics/drawable/Drawable;
