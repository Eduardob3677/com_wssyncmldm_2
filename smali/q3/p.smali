...
.method static constructor <clinit>()V
    ...
    invoke-static {v1, v0}, LJ3/g;->g(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;

    move-result-object v0

    const-string v2, "java/lang/annotation/Annotation.annotationType()Ljava/lang/Class;"

    invoke-static {v0, v2}, LR2/B;->R(Ljava/util/Set;Ljava/lang/Object;)Ljava/util/LinkedHashSet;

    move-result-object v0

    sput-object v0, Lq3/p;->a:Ljava/util/LinkedHashSet;

    sget-object v0, LY3/c;->g:LY3/c;

    sget-object v2, LY3/c;->h:LY3/c;

    filled-new-array {v0, v2}, [LY3/c;
    ...
    invoke-virtual {v5}, LQ3/c;->f()LQ3/f;
    ...
    iget-object v6, v3, LY3/c;->d:Ljava/lang/String;
    ...
    invoke-static {v5, v3}, LJ3/g;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v5, v3}, LJ3/g;->g(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;

    move-result-object v3

    invoke-static {v2, v3}, LR2/B;->S(Ljava/util/Set;Ljava/util/Collection;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v6, v3}, LJ3/g;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v9, v8}, LJ3/g;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;

    move-result-object v8

    invoke-static {v2, v8}, LR2/B;->S(Ljava/util/Set;Ljava/util/Collection;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v7, v3}, LJ3/g;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v8, v3}, LJ3/g;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    sput-object v2, Lq3/p;->b:Ljava/util/LinkedHashSet;
    ...
    invoke-static {v8, v2}, LJ3/g;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v8, v3}, LJ3/g;->g(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v9, v3}, LJ3/g;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v1, v3}, LJ3/g;->g(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v5, v8}, LJ3/g;->g(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v10, v8}, LJ3/g;->g(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    sput-object v2, Lq3/p;->c:Ljava/util/LinkedHashSet;

    filled-new-array {v11}, [Ljava/lang/String;

    move-result-object v2

    invoke-static {v1, v2}, LJ3/g;->g(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v5, v0}, LJ3/g;->g(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;

    move-result-object v0

    invoke-static {v1, v0}, LR2/B;->S(Ljava/util/Set;Ljava/util/Collection;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v10, v1}, LJ3/g;->g(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    sput-object v0, Lq3/p;->d:Ljava/util/LinkedHashSet;

    sget-object v10, LY3/c;->g:LY3/c;

    sget-object v14, LY3/c;->i:LY3/c;

    sget-object v12, LY3/c;->n:LY3/c;

    sget-object v13, LY3/c;->l:LY3/c;

    sget-object v15, LY3/c;->k:LY3/c;

    sget-object v16, LY3/c;->m:LY3/c;

    sget-object v17, LY3/c;->j:LY3/c;

    move-object v11, v14

    filled-new-array/range {v10 .. v17}, [LY3/c;
    ...
    invoke-virtual {v2}, LY3/c;->e()LQ3/c;
    ...
    invoke-static {v3}, LJ3/g;->a([Ljava/lang/String;)[Ljava/lang/String;
    ...
    invoke-static {v2, v3}, LJ3/g;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;

    move-result-object v2

    invoke-static {v1, v2}, LR2/s;->E0(Ljava/util/Collection;Ljava/lang/Iterable;)V
    ...
    invoke-static {v7, v0}, LJ3/g;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v6, v1}, LJ3/g;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    sput-object v0, Lq3/p;->e:Ljava/util/LinkedHashSet;
    ...
    invoke-static {v9, v0}, LJ3/g;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;

    move-result-object v0

    sput-object v0, Lq3/p;->f:Ljava/util/LinkedHashSet;
