...
.field public static final o:Le4/d;

.field public static final p:LP1/e;
...
.method public final k(II)Landroid/view/accessibility/AccessibilityEvent;
    ...
    invoke-virtual {v0}, LK/h;->f()Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0, p1, p2}, LS/b;->t(ILandroid/view/accessibility/AccessibilityEvent;)V
...
.method public final l(I)LK/h;
    ...
    invoke-virtual {v1, v3}, LK/h;->g(Ljava/lang/CharSequence;)V
    ...
    iget-object v5, p0, LS/b;->i:Landroid/view/View;

    invoke-virtual {v0, v5}, Landroid/view/accessibility/AccessibilityNodeInfo;->setParent(Landroid/view/View;)V

    invoke-virtual {p0, p1, v1}, LS/b;->v(ILK/h;)V

    invoke-virtual {v1}, LK/h;->f()Ljava/lang/CharSequence;
    ...
    :cond_1
    :goto_0
    iget-object v6, p0, LS/b;->e:Landroid/graphics/Rect;

    invoke-virtual {v1, v6}, LK/h;->e(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v1, v8}, LK/h;->a(I)V
    ...
    invoke-virtual {v1, v7}, LK/h;->a(I)V
    ...
    invoke-virtual {v1, v2}, LK/h;->a(I)V
    ...
    invoke-virtual {v1, v7}, LK/h;->e(Landroid/graphics/Rect;)V
    ...
    invoke-direct {v10, v8}, LK/h;-><init>(Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    iput v4, v10, LK/h;->b:I

    iget-object v11, v10, LK/h;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    invoke-virtual {p0, v8, v10}, LS/b;->v(ILK/h;)V

    invoke-virtual {v10, v6}, LK/h;->e(Landroid/graphics/Rect;)V
    ...
    :cond_7
    iget-object p0, p0, LS/b;->f:Landroid/graphics/Rect;
    ...
    iget-object p0, v1, LK/h;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
...
.method public final m(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {p0, v6, v3}, LS/b;->y(II)V

    invoke-virtual {p0, p1, v1}, LS/b;->y(II)V
    ...
    invoke-virtual {p0, v0, p1}, LS/b;->n(FF)I
...
.method public final p()V
    ...
    invoke-virtual {p0, v3, v2}, LS/b;->k(II)Landroid/view/accessibility/AccessibilityEvent;
...
.method public final q(ILandroid/graphics/Rect;)Z
    ...
    invoke-virtual {v0, v4}, LS/b;->o(Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v0, v8}, LS/b;->l(I)LK/h;
    ...
    invoke-virtual {v5, v9, v8}, Lo/l;->e(ILjava/lang/Object;)V
    ...
    :cond_1
    invoke-virtual {v5, v8, v4}, Lo/l;->c(Ljava/lang/Integer;I)Ljava/lang/Object;
    ...
    :goto_1
    sget-object v9, LS/b;->o:Le4/d;

    sget-object v10, LS/b;->p:LP1/e;

    iget-object v11, v0, LS/b;->i:Landroid/view/View;
    ...
    invoke-virtual {v0, v6}, LS/b;->r(I)LK/h;

    move-result-object v2

    invoke-virtual {v2, v3}, LK/h;->e(Landroid/graphics/Rect;)V
    ...
    iget-object v10, v5, Lo/l;->d:[Ljava/lang/Object;
    ...
    invoke-virtual {v10, v8}, LK/h;->e(Landroid/graphics/Rect;)V

    invoke-static {v1, v3, v8}, LW1/a;->O(ILandroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    :cond_f
    invoke-static {v1, v3, v2}, LW1/a;->O(ILandroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    :cond_10
    invoke-static {v1, v3, v8, v2}, LW1/a;->c(ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    :cond_11
    invoke-static {v1, v3, v2, v8}, LW1/a;->c(ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    :cond_12
    invoke-static {v1, v3, v8}, LW1/a;->Z(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I

    move-result v12

    invoke-static {v1, v3, v8}, LW1/a;->b0(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I
    ...
    invoke-static {v1, v3, v2}, LW1/a;->Z(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I

    move-result v12

    invoke-static {v1, v3, v2}, LW1/a;->b0(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I
    ...
    iget-object v8, v5, Lo/l;->d:[Ljava/lang/Object;
    ...
    invoke-direct {v3, v2, v9}, LS/c;-><init>(ZLe4/d;)V
    ...
    iget-object v2, v5, Lo/l;->d:[Ljava/lang/Object;
    ...
    :goto_12
    iget-object v1, v5, Lo/l;->c:[I

    aget v7, v1, v13

    :goto_13
    invoke-virtual {v0, v7}, LS/b;->x(I)Z
...
.method public final r(I)LK/h;
    ...
    iget-object p1, p0, LS/b;->i:Landroid/view/View;
    ...
    invoke-virtual {p0, v2}, LS/b;->o(Ljava/util/ArrayList;)V
    ...
    iget-object v4, v1, LK/h;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
