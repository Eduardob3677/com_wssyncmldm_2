...
.method public final a(Landroid/content/Context;Landroid/util/AttributeSet;)Lk/o;
    ...
    invoke-direct {p0, p1, p2}, LS1/u;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public final c(Landroid/content/Context;Landroid/util/AttributeSet;)Lk/p;
    ...
    invoke-direct {p0, p1, p2}, LE1/c;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public final d(Landroid/content/Context;Landroid/util/AttributeSet;)Lk/B;
    ...
    invoke-direct {p0, p1, p2}, Lk/B;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object p1

    sget-object v3, Lv1/a;->q:[I
    ...
    invoke-static {p1, p2, v0}, LW1/a;->B(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
...
.method public final e(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatTextView;
    ...
    invoke-static {p1, p2, v0, v1}, LU1/a;->a(Landroid/content/Context;Landroid/util/AttributeSet;II)Landroid/content/Context;
    ...
    invoke-static {p1, v2, v3}, LL2/b;->F(Landroid/content/Context;IZ)Z
    ...
    invoke-static {p1, v5, v7}, LT1/a;->q(Landroid/content/Context;Landroid/content/res/TypedArray;[I)I
    ...
    invoke-static {p2, p1, v0}, LT1/a;->q(Landroid/content/Context;Landroid/content/res/TypedArray;[I)I
