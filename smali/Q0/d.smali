...
.method public final a(LL0/b;IZ)V
    ...
    iget-object v4, v0, LQ0/d;->a:Landroid/content/Context;
    ...
    iget-object v4, v1, LL0/b;->a:Ljava/lang/String;
    ...
    iget-object v7, v1, LL0/b;->c:LI0/c;
    ...
    invoke-static {v8, v0, v1}, LW1/a;->t(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V

    return-void

    :cond_2
    iget-object v10, v0, LQ0/d;->b:LR0/c;

    check-cast v10, LR0/h;

    invoke-virtual {v10}, LR0/h;->g()Landroid/database/sqlite/SQLiteDatabase;
    ...
    iget-object v12, v1, LL0/b;->a:Ljava/lang/String;
    ...
    iget-object v0, v0, LQ0/d;->c:LQ0/b;

    move-object v3, v5

    move/from16 v16, v6

    invoke-virtual {v0, v7, v14, v15, v2}, LQ0/b;->a(LI0/c;JI)J

    move-result-wide v5

    invoke-virtual {v10, v5, v6}, Landroid/app/job/JobInfo$Builder;->setMinimumLatency(J)Landroid/app/job/JobInfo$Builder;

    iget-object v5, v0, LQ0/b;->b:Ljava/util/Map;
    ...
    iget-object v5, v5, LQ0/c;->c:Ljava/util/Set;
