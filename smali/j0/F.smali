...
.method public final c(Lj0/b0;)V
    ...
    iget-object p0, p0, Lj0/F;->a:Lj0/y;
    ...
    iput-object v2, p1, Lj0/b0;->h:Lj0/b0;

    :cond_0
    iput-object v2, p1, Lj0/b0;->i:Lj0/b0;
    ...
    iget-object v1, p0, Landroidx/recyclerview/widget/RecyclerView;->h:LD3/f;

    iget-object v2, v1, LD3/f;->d:Ljava/lang/Object;

    check-cast v2, Lj0/c;

    iget-object v3, v1, LD3/f;->c:Ljava/lang/Object;

    check-cast v3, Lj0/y;

    iget v4, v1, LD3/f;->b:I

    const/4 v5, 0x0

    iget-object v6, p1, Lj0/b0;->a:Landroid/view/View;

    if-ne v4, v0, :cond_4

    iget-object v0, v1, LD3/f;->f:Ljava/lang/Object;
    ...
    :try_start_0
    iput v7, v1, LD3/f;->b:I

    iget-object v4, v3, Lj0/y;->a:Landroidx/recyclerview/widget/RecyclerView;
    ...
    invoke-virtual {v1, v6}, LD3/f;->n(Landroid/view/View;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :goto_2
    iput v5, v1, LD3/f;->b:I
    ...
    :cond_5
    :try_start_1
    invoke-virtual {v2, v4}, Lj0/c;->d(I)Z

    move-result v7

    if-eqz v7, :cond_6

    invoke-virtual {v2, v4}, Lj0/c;->f(I)Z

    invoke-virtual {v1, v6}, LD3/f;->n(Landroid/view/View;)V

    invoke-virtual {v3, v4}, Lj0/y;->h(I)V
    :try_end_1
    ...
    iget-object v2, p0, Landroidx/recyclerview/widget/RecyclerView;->e:Lj0/P;

    invoke-virtual {v2, v1}, Lj0/P;->l(Lj0/b0;)V

    invoke-virtual {v2, v1}, Lj0/P;->i(Lj0/b0;)V
