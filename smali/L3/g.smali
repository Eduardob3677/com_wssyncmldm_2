...
.method static constructor <clinit>()V
    ...
    iput v1, v0, LL3/g;->e:I

    invoke-static {}, Ljava/util/Collections;->emptyList()Ljava/util/List;

    move-result-object v1

    iput-object v1, v0, LL3/g;->f:Ljava/util/List;
...
.method public constructor <init>()V
    ...
    iput-byte v0, p0, LL3/g;->g:B

    iput v0, p0, LL3/g;->h:I

    sget-object v0, LR3/e;->c:LR3/z;

    iput-object v0, p0, LL3/g;->c:LR3/e;
...
.method public constructor <init>(LR3/f;LR3/i;)V
    ...
    iput-object v1, p0, LL3/g;->f:Ljava/util/List;
    ...
    invoke-virtual {p1, v6, v3}, LR3/f;->q(ILB1/j;)Z
    ...
    iput-object v6, p0, LL3/g;->f:Ljava/util/List;
    ...
    :cond_3
    :goto_1
    iget-object v6, p0, LL3/g;->f:Ljava/util/List;

    sget-object v7, LL3/e;->j:LL3/a;
    ...
    :cond_4
    iget v6, p0, LL3/g;->d:I

    or-int/2addr v6, v2

    iput v6, p0, LL3/g;->d:I

    invoke-virtual {p1}, LR3/f;->k()I

    move-result v6

    iput v6, p0, LL3/g;->e:I
    :try_end_0
    ...
    iget-object p2, p0, LL3/g;->f:Ljava/util/List;

    invoke-static {p2}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p2

    iput-object p2, p0, LL3/g;->f:Ljava/util/List;
    ...
    iput-object p2, p0, LL3/g;->c:LR3/e;
    ...
    iget-object p1, p0, LL3/g;->f:Ljava/util/List;

    invoke-static {p1}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, LL3/g;->f:Ljava/util/List;
    ...
    iput-object p1, p0, LL3/g;->c:LR3/e;
...
.method public final b()Z
    ...
    :goto_0
    iget-object v3, p0, LL3/g;->f:Ljava/util/List;
    ...
    invoke-virtual {v3}, LL3/e;->b()Z

    move-result v3

    if-nez v3, :cond_2

    iput-byte v2, p0, LL3/g;->g:B
...
.method public final c()I
    ...
    :goto_0
    iget-object v1, p0, LL3/g;->f:Ljava/util/List;
    ...
    :cond_2
    iget-object v1, p0, LL3/g;->c:LR3/e;
...
.method public final f(LB1/j;)V
    ...
    :cond_1
    iget-object p0, p0, LL3/g;->c:LR3/e;
