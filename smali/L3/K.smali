...
# static fields
.field public static final g:LL3/K;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, LL3/K;->h:LL3/a;

    new-instance v0, LL3/K;

    invoke-direct {v0}, LL3/K;-><init>()V

    sput-object v0, LL3/K;->g:LL3/K;

    invoke-static {}, Ljava/util/Collections;->emptyList()Ljava/util/List;

    move-result-object v1

    iput-object v1, v0, LL3/K;->d:Ljava/util/List;
...
.method public constructor <init>()V
    ...
    iput-byte v0, p0, LL3/K;->e:B

    iput v0, p0, LL3/K;->f:I

    sget-object v0, LR3/e;->c:LR3/z;

    iput-object v0, p0, LL3/K;->c:LR3/e;
...
.method public constructor <init>(LR3/f;LR3/i;)V
    ...
    iput-object v0, p0, LL3/K;->d:Ljava/util/List;
    ...
    iput-object v5, p0, LL3/K;->d:Ljava/util/List;
    ...
    :cond_3
    :goto_1
    iget-object v5, p0, LL3/K;->d:Ljava/util/List;

    sget-object v6, LL3/J;->k:LL3/a;
    ...
    iget-object p2, p0, LL3/K;->d:Ljava/util/List;

    invoke-static {p2}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p2

    iput-object p2, p0, LL3/K;->d:Ljava/util/List;
    ...
    iput-object p2, p0, LL3/K;->c:LR3/e;
    ...
    iget-object p1, p0, LL3/K;->d:Ljava/util/List;

    invoke-static {p1}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, LL3/K;->d:Ljava/util/List;
    ...
    iput-object p1, p0, LL3/K;->c:LR3/e;
...
.method public final b()Z
    ...
    :goto_0
    iget-object v3, p0, LL3/K;->d:Ljava/util/List;
...
.method public final c()I
    ...
    :goto_0
    iget-object v2, p0, LL3/K;->d:Ljava/util/List;
    ...
    :cond_1
    iget-object v0, p0, LL3/K;->c:LR3/e;
...
.method public final f(LB1/j;)V
    ...
    invoke-virtual {p0}, LL3/K;->c()I

    const/4 v0, 0x0

    :goto_0
    iget-object v1, p0, LL3/K;->d:Ljava/util/List;
    ...
    :cond_0
    iget-object p0, p0, LL3/K;->c:LR3/e;
