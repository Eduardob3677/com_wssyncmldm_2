...
.field public final a0:Landroid/view/animation/PathInterpolator;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v12, v7, Landroidx/appcompat/widget/SwitchCompat;->d:Landroid/content/res/ColorStateList;

    iput-object v12, v7, Landroidx/appcompat/widget/SwitchCompat;->e:Landroid/graphics/PorterDuff$Mode;

    const/4 v13, 0x0

    iput-boolean v13, v7, Landroidx/appcompat/widget/SwitchCompat;->f:Z

    iput-boolean v13, v7, Landroidx/appcompat/widget/SwitchCompat;->g:Z

    iput-object v12, v7, Landroidx/appcompat/widget/SwitchCompat;->i:Landroid/content/res/ColorStateList;

    iput-object v12, v7, Landroidx/appcompat/widget/SwitchCompat;->j:Landroid/graphics/PorterDuff$Mode;

    iput-boolean v13, v7, Landroidx/appcompat/widget/SwitchCompat;->k:Z

    iput-boolean v13, v7, Landroidx/appcompat/widget/SwitchCompat;->l:Z
    ...
    iput v13, v7, Landroidx/appcompat/widget/SwitchCompat;->b0:I

    invoke-virtual/range {p0 .. p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v0

    invoke-static {v7, v0}, Lk/v1;->a(Landroid/view/View;Landroid/content/Context;)V

    new-instance v14, Landroid/text/TextPaint;

    invoke-direct {v14, v10}, Landroid/text/TextPaint;-><init>(I)V

    iput-object v14, v7, Landroidx/appcompat/widget/SwitchCompat;->I:Landroid/text/TextPaint;
    ...
    invoke-direct {v15, v8, v6}, LJ/r0;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-virtual {v15, v0}, LJ/r0;->g(I)Landroid/graphics/drawable/Drawable;

    move-result-object v1

    iput-object v1, v7, Landroidx/appcompat/widget/SwitchCompat;->c:Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v15, v1}, LJ/r0;->g(I)Landroid/graphics/drawable/Drawable;

    move-result-object v1

    iput-object v1, v7, Landroidx/appcompat/widget/SwitchCompat;->h:Landroid/graphics/drawable/Drawable;

    if-eqz v1, :cond_3

    invoke-virtual {v1, v7}, Landroid/graphics/drawable/Drawable;->setCallback(Landroid/graphics/drawable/Drawable$Callback;)V

    iget-object v1, v7, Landroidx/appcompat/widget/SwitchCompat;->h:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v2, v7, Landroidx/appcompat/widget/SwitchCompat;->T:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v1}, Landroid/graphics/drawable/Drawable$ConstantState;->newDrawable()Landroid/graphics/drawable/Drawable;

    move-result-object v1

    iput-object v1, v7, Landroidx/appcompat/widget/SwitchCompat;->U:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v1, v7, Landroidx/appcompat/widget/SwitchCompat;->T:Landroid/graphics/drawable/Drawable;

    iput-object v1, v7, Landroidx/appcompat/widget/SwitchCompat;->U:Landroid/graphics/drawable/Drawable;

    :goto_1
    iget-object v1, v7, Landroidx/appcompat/widget/SwitchCompat;->T:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v1, v7, Landroidx/appcompat/widget/SwitchCompat;->U:Landroid/graphics/drawable/Drawable;
    ...
    iput-boolean v2, v7, Landroidx/appcompat/widget/SwitchCompat;->u:Z
    ...
    iput v2, v7, Landroidx/appcompat/widget/SwitchCompat;->n:I
    ...
    iput v2, v7, Landroidx/appcompat/widget/SwitchCompat;->o:I
    ...
    iput-boolean v2, v7, Landroidx/appcompat/widget/SwitchCompat;->p:Z

    const/16 v2, 0xa

    invoke-virtual {v15, v2}, LJ/r0;->f(I)Landroid/content/res/ColorStateList;

    move-result-object v2

    if-eqz v2, :cond_4

    iput-object v2, v7, Landroidx/appcompat/widget/SwitchCompat;->d:Landroid/content/res/ColorStateList;

    iput-boolean v10, v7, Landroidx/appcompat/widget/SwitchCompat;->f:Z
    ...
    invoke-static {v2, v12}, Lk/g0;->b(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v2

    iget-object v4, v7, Landroidx/appcompat/widget/SwitchCompat;->e:Landroid/graphics/PorterDuff$Mode;

    if-eq v4, v2, :cond_5

    iput-object v2, v7, Landroidx/appcompat/widget/SwitchCompat;->e:Landroid/graphics/PorterDuff$Mode;

    iput-boolean v10, v7, Landroidx/appcompat/widget/SwitchCompat;->g:Z

    :cond_5
    iget-boolean v2, v7, Landroidx/appcompat/widget/SwitchCompat;->f:Z
    ...
    iput-object v2, v7, Landroidx/appcompat/widget/SwitchCompat;->i:Landroid/content/res/ColorStateList;

    iput-boolean v10, v7, Landroidx/appcompat/widget/SwitchCompat;->k:Z
    ...
    invoke-static {v4, v12}, Lk/g0;->b(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v4

    iget-object v5, v7, Landroidx/appcompat/widget/SwitchCompat;->j:Landroid/graphics/PorterDuff$Mode;

    if-eq v5, v4, :cond_9

    iput-object v4, v7, Landroidx/appcompat/widget/SwitchCompat;->j:Landroid/graphics/PorterDuff$Mode;

    iput-boolean v10, v7, Landroidx/appcompat/widget/SwitchCompat;->l:Z

    :cond_9
    iget-boolean v4, v7, Landroidx/appcompat/widget/SwitchCompat;->k:Z

    if-nez v4, :cond_a

    iget-boolean v4, v7, Landroidx/appcompat/widget/SwitchCompat;->l:Z
    ...
    invoke-static {v8, v6}, Lz/d;->b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    iput-object v6, v7, Landroidx/appcompat/widget/SwitchCompat;->J:Landroid/content/res/ColorStateList;
    ...
    iput-object v0, v7, Landroidx/appcompat/widget/SwitchCompat;->M:Lh/a;

    goto :goto_a

    :cond_17
    iput-object v12, v7, Landroidx/appcompat/widget/SwitchCompat;->M:Lh/a;
    ...
    iget-object v0, v7, Landroidx/appcompat/widget/SwitchCompat;->s:Ljava/lang/CharSequence;
    ...
    invoke-direct {v0, v7}, Lk/V;-><init>(Landroid/widget/TextView;)V

    const v1, 0x7f040489

    invoke-virtual {v0, v9, v1}, Lk/V;->f(Landroid/util/AttributeSet;I)V

    invoke-virtual {v15}, LJ/r0;->n()V
    ...
    invoke-direct/range {p0 .. p0}, Landroidx/appcompat/widget/SwitchCompat;->getEmojiTextViewHelper()Lk/v;

    move-result-object v0

    invoke-virtual {v0, v9, v1}, Lk/v;->b(Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, v7, Landroidx/appcompat/widget/SwitchCompat;->V:Ljava/lang/String;
    ...
    iput-object v0, v7, Landroidx/appcompat/widget/SwitchCompat;->W:Ljava/lang/String;
    ...
    iput-object v0, v7, Landroidx/appcompat/widget/SwitchCompat;->a0:Landroid/view/animation/PathInterpolator;
...
.method private getEmojiTextViewHelper()Lk/v;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->O:Lk/v;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->O:Lk/v;

    :cond_0
    iget-object p0, p0, Landroidx/appcompat/widget/SwitchCompat;->O:Lk/v;
...
.method private getThumbScrollRange()I
    ...
    iget p0, p0, Landroidx/appcompat/widget/SwitchCompat;->D:I
...
.method private setTextOffInternal(Ljava/lang/CharSequence;)V
    ...
    iget-object v0, v0, Lk/v;->b:Ls2/c;

    iget-object v0, v0, Ls2/c;->c:Ljava/lang/Object;

    check-cast v0, Lf1/a;

    invoke-virtual {v0, v1}, Lf1/a;->s0(Landroid/text/method/TransformationMethod;)Landroid/text/method/TransformationMethod;
...
.method public final c(Z)Z
    ...
    invoke-static {p1, p0}, Lp0/a;->m(Landroid/graphics/Rect;Landroid/view/View;)Z
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v5}, Lk/g0;->a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    :cond_0
    sget-object v5, Lk/g0;->a:Landroid/graphics/Rect;
    ...
    invoke-static {v2, v0, v1, v4, v3}, LC/a;->f(Landroid/graphics/drawable/Drawable;IIII)V
...
.method public final e()V
    ...
    invoke-virtual {v1, p0, v0}, LJ/F;->e(Landroid/view/View;Ljava/lang/Object;)V
...
.method public final f()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->V:Ljava/lang/String;
...
.method public final g()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->Q:LX/h;
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->Q:LX/h;
...
.method public final jumpDrawablesToCurrentState()V
    ...
    :cond_1
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->N:Lk/u1;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->N:Lk/u1;
...
.method public final onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/SwitchCompat;->V:Ljava/lang/String;
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/SwitchCompat;->W:Ljava/lang/String;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-boolean v6, p0, Landroidx/appcompat/widget/SwitchCompat;->p:Z
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->U:Landroid/graphics/drawable/Drawable;
    ...
    iget v6, p0, Landroidx/appcompat/widget/SwitchCompat;->A:F
    ...
    iget-object v8, p0, Landroidx/appcompat/widget/SwitchCompat;->I:Landroid/text/TextPaint;
...
.method public final onLayout(ZIIII)V
    ...
    invoke-static {p1}, Lk/g0;->a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    iget p5, p0, Landroidx/appcompat/widget/SwitchCompat;->b0:I
...
.method public final onPopulateAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
    ...
    iget-object p0, p0, Landroidx/appcompat/widget/SwitchCompat;->V:Ljava/lang/String;

    goto :goto_0

    :cond_0
    iget-object p0, p0, Landroidx/appcompat/widget/SwitchCompat;->W:Ljava/lang/String;
...
.method public setChecked(Z)V
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->N:Lk/u1;
    ...
    :cond_3
    invoke-direct {v0, p0, v1, v2}, Lk/u1;-><init>(Landroidx/appcompat/widget/SwitchCompat;FF)V
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->a0:Landroid/view/animation/PathInterpolator;
    ...
    invoke-direct {v1, p0, p1}, Lk/t1;-><init>(Landroidx/appcompat/widget/SwitchCompat;Z)V

    invoke-virtual {v0, v1}, Landroid/view/animation/Animation;->setAnimationListener(Landroid/view/animation/Animation$AnimationListener;)V

    iget-object p1, p0, Landroidx/appcompat/widget/SwitchCompat;->N:Lk/u1;
...
.method public setTrackDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->T:Landroid/graphics/drawable/Drawable;
